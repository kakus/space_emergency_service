...
arguments)}function k(){k.b2DistanceOutput.apply(this,arguments)}function l(){l.b2DistanceProxy.apply(this,arguments)}function p(){p.b2DynamicTree.apply(this,arguments);this.constructor===p&&this.b2DynamicTree.apply(this,arguments)}function s(){s.b2DynamicTreeBroadPhase.apply(this,arguments)}function x(){x.b2DynamicTreeNode.apply(this,arguments)}function v(){v.b2DynamicTreePair.apply(this,arguments)}function w(){w.b2Manifold.apply(this,arguments);this.constructor===w&&this.b2Manifold.apply(this,arguments)}
function F(){F.b2ManifoldPoint.apply(this,arguments);this.constructor===F&&this.b2ManifoldPoint.apply(this,arguments)}function r(){r.b2Point.apply(this,arguments)}function E(){E.b2RayCastInput.apply(this,arguments);this.constructor===E&&this.b2RayCastInput.apply(this,arguments)}function A(){A.b2RayCastOutput.apply(this,arguments)}function z(){z.b2Segment.apply(this,arguments)}function D(){D.b2SeparationFunction.apply(this,arguments)}function H(){H.b2Simplex.apply(this,arguments);this.constructor===
...
(function(){var b=Box2D.Collision.Shapes.b2CircleShape,c=Box2D.Collision.Shapes.b2PolygonShape,a=Box2D.Collision.Shapes.b2Shape,f=Box2D.Common.b2Settings,e=Box2D.Common.Math.b2Math,d=Box2D.Common.Math.b2Sweep,g=Box2D.Common.Math.b2Transform,h=Box2D.Common.Math.b2Vec2,k=Box2D.Collision.b2AABB,l=Box2D.Collision.b2Bound,p=Box2D.Collision.b2BoundValues,s=Box2D.Collision.b2Collision,x=Box2D.Collision.b2ContactID,v=Box2D.Collision.b2ContactPoint,w=Box2D.Collision.b2Distance,F=Box2D.Collision.b2DistanceInput,
r=Box2D.Collision.b2DistanceOutput,E=Box2D.Collision.b2DistanceProxy,A=Box2D.Collision.b2DynamicTree,z=Box2D.Collision.b2DynamicTreeBroadPhase,D=Box2D.Collision.b2DynamicTreeNode,H=Box2D.Collision.b2DynamicTreePair,C=Box2D.Collision.b2Manifold,M=Box2D.Collision.b2ManifoldPoint,G=Box2D.Collision.b2Point,I=Box2D.Collision.b2RayCastInput,N=Box2D.Collision.b2RayCastOutput,L=Box2D.Collision.b2Segment,q=Box2D.Collision.b2SeparationFunction,t=Box2D.Collision.b2Simplex,B=Box2D.Collision.b2SimplexCache,y=
Box2D.Collision.b2SimplexVertex,K=Box2D.Collision.b2TimeOfImpact,P=Box2D.Collision.b2TOIInput,O=Box2D.Collision.b2WorldManifold,u=Box2D.Collision.ClipVertex,m=Box2D.Collision.Features,J=Box2D.Collision.IBroadPhase;k.b2AABB=function(){this.lowerBound=new h;this.upperBound=new h};k.prototype.IsValid=function(){var a=this.upperBound.y-this.lowerBound.y;return 0<=this.upperBound.x-this.lowerBound.x&&0<=a&&this.lowerBound.IsValid()&&this.upperBound.IsValid()};k.prototype.GetCenter=function(){return new h((this.lowerBound.x+
this.upperBound.x)/2,(this.lowerBound.y+this.upperBound.y)/2)};k.prototype.GetExtents=function(){return new h((this.upperBound.x-this.lowerBound.x)/2,(this.upperBound.y-this.lowerBound.y)/2)};k.prototype.Contains=function(a){return this.lowerBound.x<=a.lowerBound.x&&this.lowerBound.y<=a.lowerBound.y&&a.upperBound.x<=this.upperBound.x&&a.upperBound.y<=this.upperBound.y};k.prototype.RayCast=function(a,b){var c=-Number.MAX_VALUE,f=Number.MAX_VALUE,e=b.p1.x,u=b.p1.y,d=b.p2.x-b.p1.x,q=b.p2.y-b.p1.y,m=
Math.abs(q),h=a.normal,t=0,y=0,g=0;if(Math.abs(d)<Number.MIN_VALUE){if(e<this.lowerBound.x||this.upperBound.x<e)return!1}else if(t=1/d,y=(this.lowerBound.x-e)*t,t*=this.upperBound.x-e,g=-1,y>t&&(g=y,y=t,t=g,g=1),y>c&&(h.x=g,h.y=0,c=y),f=Math.min(f,t),c>f)return!1;if(m<Number.MIN_VALUE){if(u<this.lowerBound.y||this.upperBound.y<u)return!1}else if(t=1/q,y=(this.lowerBound.y-u)*t,t*=this.upperBound.y-u,g=-1,y>t&&(g=y,y=t,t=g,g=1),y>c&&(h.y=g,h.x=0,c=y),f=Math.min(f,t),c>f)return!1;a.fraction=c;return!0};
...
b.upperBound.y)};l.b2Bound=function(){};l.prototype.IsLower=function(){return 0==(this.value&1)};l.prototype.IsUpper=function(){return 1==(this.value&1)};l.prototype.Swap=function(a){var b=this.value,c=this.proxy,f=this.stabbingCount;this.value=a.value;this.proxy=a.proxy;this.stabbingCount=a.stabbingCount;a.value=b;a.proxy=c;a.stabbingCount=f};p.b2BoundValues=function(){};p.prototype.b2BoundValues=function(){this.lowerValues=new Vector_a2j_Number;this.lowerValues[0]=0;this.lowerValues[1]=0;this.upperValues=
new Vector_a2j_Number;this.upperValues[0]=0;this.upperValues[1]=0};s.b2Collision=function(){};s.ClipSegmentToLine=function(a,b,c,f){void 0===f&&(f=0);var e,u=0;e=b[0];var d=e.v;e=b[1];var q=e.v,m=c.x*d.x+c.y*d.y-f;e=c.x*q.x+c.y*q.y-f;0>=m&&a[u++].Set(b[0]);0>=e&&a[u++].Set(b[1]);0>m*e&&(c=m/(m-e),e=a[u],e=e.v,e.x=d.x+c*(q.x-d.x),e.y=d.y+c*(q.y-d.y),e=a[u],e.id=(0<m?b[0]:b[1]).id,++u);return u};s.EdgeSeparation=function(a,b,c,f,e){void 0===c&&(c=0);parseInt(a.m_vertexCount);var u=a.m_vertices;a=a.m_normals;
var d=parseInt(f.m_vertexCount),q=f.m_vertices,m,h;m=b.R;h=a[c];a=m.col1.x*h.x+m.col2.x*h.y;f=m.col1.y*h.x+m.col2.y*h.y;m=e.R;var t=m.col1.x*a+m.col1.y*f;m=m.col2.x*a+m.col2.y*f;for(var y=0,g=Number.MAX_VALUE,J=0;J<d;++J)h=q[J],h=h.x*t+h.y*m,h<g&&(g=h,y=J);h=u[c];m=b.R;c=b.position.x+(m.col1.x*h.x+m.col2.x*h.y);b=b.position.y+(m.col1.y*h.x+m.col2.y*h.y);h=q[y];m=e.R;u=e.position.x+(m.col1.x*h.x+m.col2.x*h.y);e=e.position.y+(m.col1.y*h.x+m.col2.y*h.y);return(u-c)*a+(e-b)*f};s.FindMaxSeparation=function(a,
b,c,f,e){var u=parseInt(b.m_vertexCount),d=b.m_normals,m,q;q=e.R;m=f.m_centroid;var h=e.position.x+(q.col1.x*m.x+q.col2.x*m.y),t=e.position.y+(q.col1.y*m.x+q.col2.y*m.y);q=c.R;m=b.m_centroid;h-=c.position.x+(q.col1.x*m.x+q.col2.x*m.y);t-=c.position.y+(q.col1.y*m.x+q.col2.y*m.y);q=h*c.R.col1.x+t*c.R.col1.y;for(var t=h*c.R.col2.x+t*c.R.col2.y,h=0,y=-Number.MAX_VALUE,g=0;g<u;++g)m=d[g],m=m.x*q+m.y*t,m>y&&(y=m,h=g);d=s.EdgeSeparation(b,c,h,f,e);m=parseInt(0<=h-1?h-1:u-1);q=s.EdgeSeparation(b,c,m,f,e);
var t=parseInt(h+1<u?h+1:0),y=s.EdgeSeparation(b,c,t,f,e),J=0,r=0;if(q>d&&q>y)r=-1,g=m,J=q;else if(y>d)r=1,g=t,J=y;else return a[0]=h,d;for(;;)if(h=-1==r?0<=g-1?g-1:u-1:g+1<u?g+1:0,d=s.EdgeSeparation(b,c,h,f,e),d>J)g=h,J=d;else break;a[0]=g;return J};s.FindIncidentEdge=function(a,b,c,f,e,u){void 0===f&&(f=0);parseInt(b.m_vertexCount);var d=b.m_normals,m=parseInt(e.m_vertexCount);b=e.m_vertices;e=e.m_normals;var q;q=c.R;c=d[f];var d=q.col1.x*c.x+q.col2.x*c.y,h=q.col1.y*c.x+q.col2.y*c.y;q=u.R;c=q.col1.x*
d+q.col1.y*h;h=q.col2.x*d+q.col2.y*h;d=c;q=0;for(var t=Number.MAX_VALUE,y=0;y<m;++y)c=e[y],c=d*c.x+h*c.y,c<t&&(t=c,q=y);e=parseInt(q);d=parseInt(e+1<m?e+1:0);m=a[0];c=b[e];q=u.R;m.v.x=u.position.x+(q.col1.x*c.x+q.col2.x*c.y);m.v.y=u.position.y+(q.col1.y*c.x+q.col2.y*c.y);m.id.features.referenceEdge=f;m.id.features.incidentEdge=e;m.id.features.incidentVertex=0;m=a[1];c=b[d];q=u.R;m.v.x=u.position.x+(q.col1.x*c.x+q.col2.x*c.y);m.v.y=u.position.y+(q.col1.y*c.x+q.col2.y*c.y);m.id.features.referenceEdge=
f;m.id.features.incidentEdge=d;m.id.features.incidentVertex=1};s.MakeClipPointVector=function(){var a=new Vector(2);a[0]=new u;a[1]=new u;return a};s.CollidePolygons=function(a,c,b,e,u){var d;a.m_pointCount=0;var m=c.m_radius+e.m_radius;s.s_edgeAO[0]=0;var q=s.FindMaxSeparation(s.s_edgeAO,c,b,e,u);d=s.s_edgeAO[0];if(!(q>m)){var h;s.s_edgeBO[0]=0;var t=s.FindMaxSeparation(s.s_edgeBO,e,u,c,b);h=s.s_edgeBO[0];if(!(t>m)){var y=0,g=0;t>0.98*q+0.001?(q=e,e=c,c=u,y=h,a.m_type=C.e_faceB,g=1):(q=c,c=b,b=u,
y=d,a.m_type=C.e_faceA,g=0);d=s.s_incidentEdge;s.FindIncidentEdge(d,q,c,y,e,b);h=parseInt(q.m_vertexCount);u=q.m_vertices;var q=u[y],J;J=y+1<h?u[parseInt(y+1)]:u[0];y=s.s_localTangent;y.Set(J.x-q.x,J.y-q.y);y.Normalize();u=s.s_localNormal;u.x=y.y;u.y=-y.x;e=s.s_planePoint;e.Set(0.5*(q.x+J.x),0.5*(q.y+J.y));t=s.s_tangent;h=c.R;t.x=h.col1.x*y.x+h.col2.x*y.y;t.y=h.col1.y*y.x+h.col2.y*y.y;var r=s.s_tangent2;r.x=-t.x;r.y=-t.y;y=s.s_normal;y.x=t.y;y.y=-t.x;var k=s.s_v11,B=s.s_v12;k.x=c.position.x+(h.col1.x*
q.x+h.col2.x*q.y);k.y=c.position.y+(h.col1.y*q.x+h.col2.y*q.y);B.x=c.position.x+(h.col1.x*J.x+h.col2.x*J.y);B.y=c.position.y+(h.col1.y*J.x+h.col2.y*J.y);c=y.x*k.x+y.y*k.y;h=t.x*B.x+t.y*B.y+m;J=s.s_clipPoints1;q=s.s_clipPoints2;B=s.ClipSegmentToLine(J,d,r,-t.x*k.x-t.y*k.y+m);if(!(2>B)&&(B=s.ClipSegmentToLine(q,J,t,h),!(2>B))){a.m_localPlaneNormal.SetV(u);a.m_localPoint.SetV(e);for(e=u=0;e<f.b2_maxManifoldPoints;++e)d=q[e],y.x*d.v.x+y.y*d.v.y-c<=m&&(t=a.m_points[u],h=b.R,r=d.v.x-b.position.x,k=d.v.y-
b.position.y,t.m_localPoint.x=r*h.col1.x+k*h.col1.y,t.m_localPoint.y=r*h.col2.x+k*h.col2.y,t.m_id.Set(d.id),t.m_id.features.flip=g,++u);a.m_pointCount=u}}}};s.CollideCircles=function(a,c,b,f,e){a.m_pointCount=0;var u,d;u=b.R;d=c.m_p;var q=b.position.x+(u.col1.x*d.x+u.col2.x*d.y);b=b.position.y+(u.col1.y*d.x+u.col2.y*d.y);u=e.R;d=f.m_p;q=e.position.x+(u.col1.x*d.x+u.col2.x*d.y)-q;e=e.position.y+(u.col1.y*d.x+u.col2.y*d.y)-b;u=c.m_radius+f.m_radius;q*q+e*e>u*u||(a.m_type=C.e_circles,a.m_localPoint.SetV(c.m_p),
a.m_localPlaneNormal.SetZero(),a.m_pointCount=1,a.m_points[0].m_localPoint.SetV(f.m_p),a.m_points[0].m_id.key=0)};s.CollidePolygonAndCircle=function(a,c,b,f,e){var u=a.m_pointCount=0,d=0,q,m;m=e.R;q=f.m_p;var h=e.position.y+(m.col1.y*q.x+m.col2.y*q.y),u=e.position.x+(m.col1.x*q.x+m.col2.x*q.y)-b.position.x,d=h-b.position.y;m=b.R;b=u*m.col1.x+d*m.col1.y;m=u*m.col2.x+d*m.col2.y;var t=0,h=-Number.MAX_VALUE;e=c.m_radius+f.m_radius;var y=parseInt(c.m_vertexCount),g=c.m_vertices;c=c.m_normals;for(var J=
0;J<y;++J){q=g[J];u=b-q.x;d=m-q.y;q=c[J];u=q.x*u+q.y*d;if(u>e)return;u>h&&(h=u,t=J)}u=parseInt(t);d=parseInt(u+1<y?u+1:0);q=g[u];g=g[d];if(h<Number.MIN_VALUE)a.m_pointCount=1,a.m_type=C.e_faceA,a.m_localPlaneNormal.SetV(c[t]),a.m_localPoint.x=0.5*(q.x+g.x),a.m_localPoint.y=0.5*(q.y+g.y);else if(h=(b-g.x)*(q.x-g.x)+(m-g.y)*(q.y-g.y),0>=(b-q.x)*(g.x-q.x)+(m-q.y)*(g.y-q.y)){if((b-q.x)*(b-q.x)+(m-q.y)*(m-q.y)>e*e)return;a.m_pointCount=1;a.m_type=C.e_faceA;a.m_localPlaneNormal.x=b-q.x;a.m_localPlaneNormal.y=
m-q.y;a.m_localPlaneNormal.Normalize();a.m_localPoint.SetV(q)}else if(0>=h){if((b-g.x)*(b-g.x)+(m-g.y)*(m-g.y)>e*e)return;a.m_pointCount=1;a.m_type=C.e_faceA;a.m_localPlaneNormal.x=b-g.x;a.m_localPlaneNormal.y=m-g.y;a.m_localPlaneNormal.Normalize();a.m_localPoint.SetV(g)}else{t=0.5*(q.x+g.x);q=0.5*(q.y+g.y);h=(b-t)*c[u].x+(m-q)*c[u].y;if(h>e)return;a.m_pointCount=1;a.m_type=C.e_faceA;a.m_localPlaneNormal.x=c[u].x;a.m_localPlaneNormal.y=c[u].y;a.m_localPlaneNormal.Normalize();a.m_localPoint.Set(t,
...
m=new k,h=0,t=0,h=b.x+d*(f.x-b.x),t=b.y+d*(f.y-b.y);m.lowerBound.x=Math.min(b.x,h);m.lowerBound.y=Math.min(b.y,t);m.upperBound.x=Math.max(b.x,h);m.upperBound.y=Math.max(b.y,t);var y=new Vector,g=0;for(y[g++]=this.m_root;0<g;)if(d=y[--g],!1!=d.aabb.TestOverlap(m)&&(h=d.aabb.GetCenter(),t=d.aabb.GetExtents(),!(0<Math.abs(u.x*(b.x-h.x)+u.y*(b.y-h.y))-q.x*t.x-q.y*t.y)))if(d.IsLeaf()){h=new I;h.p1=c.p1;h.p2=c.p2;h.maxFraction=c.maxFraction;d=a(h,d);if(0==d)break;0<d&&(h=b.x+d*(f.x-b.x),t=b.y+d*(f.y-b.y),
m.lowerBound.x=Math.min(b.x,h),m.lowerBound.y=Math.min(b.y,t),m.upperBound.x=Math.max(b.x,h),m.upperBound.y=Math.max(b.y,t))}else y[g++]=d.child1,y[g++]=d.child2}};A.prototype.AllocateNode=function(){if(this.m_freeList){var a=this.m_freeList;this.m_freeList=a.parent;a.parent=null;a.child1=null;a.child2=null;return a}return new D};A.prototype.FreeNode=function(a){a.parent=this.m_freeList;this.m_freeList=a};A.prototype.InsertLeaf=function(a){++this.m_insertionCount;if(null==this.m_root)this.m_root=
...
(c=1/(b+a),this.m_v1.a=b*c,this.m_v2.a=a*c,this.m_count=2))};t.prototype.Solve3=function(){var a=this.m_v1.w,b=this.m_v2.w,c=this.m_v3.w,f=e.SubtractVV(b,a),u=e.Dot(a,f),m=e.Dot(b,f),u=-u,d=e.SubtractVV(c,a),q=e.Dot(a,d),h=e.Dot(c,d),q=-q,t=e.SubtractVV(c,b),y=e.Dot(b,t),t=e.Dot(c,t),y=-y,d=e.CrossVV(f,d),f=d*e.CrossVV(b,c),c=d*e.CrossVV(c,a),a=d*e.CrossVV(a,b);0>=u&&0>=q?this.m_count=this.m_v1.a=1:0<m&&0<u&&0>=a?(h=1/(m+u),this.m_v1.a=m*h,this.m_v2.a=u*h,this.m_count=2):0<h&&0<q&&0>=c?(m=1/(h+q),
this.m_v1.a=h*m,this.m_v3.a=q*m,this.m_count=2,this.m_v2.Set(this.m_v3)):0>=m&&0>=y?(this.m_count=this.m_v2.a=1,this.m_v1.Set(this.m_v2)):0>=h&&0>=t?(this.m_count=this.m_v3.a=1,this.m_v1.Set(this.m_v3)):0<t&&0<y&&0>=f?(m=1/(t+y),this.m_v2.a=t*m,this.m_v3.a=y*m,this.m_count=2,this.m_v1.Set(this.m_v3)):(m=1/(f+c+a),this.m_v1.a=f*m,this.m_v2.a=c*m,this.m_v3.a=a*m,this.m_count=3)};B.b2SimplexCache=function(){this.indexA=new Vector_a2j_Number(3);this.indexB=new Vector_a2j_Number(3)};y.b2SimplexVertex=
function(){};y.prototype.Set=function(a){this.wA.SetV(a.wA);this.wB.SetV(a.wB);this.w.SetV(a.w);this.a=a.a;this.indexA=a.indexA;this.indexB=a.indexB};K.b2TimeOfImpact=function(){};K.TimeOfImpact=function(a){++K.b2_toiCalls;var b=a.proxyA,c=a.proxyB,u=a.sweepA,m=a.sweepB;f.b2Assert(u.t0==m.t0);f.b2Assert(1-u.t0>Number.MIN_VALUE);var d=b.m_radius+c.m_radius;a=a.tolerance;var q=0,h=0,t=0;K.s_cache.count=0;for(K.s_distanceInput.useRadii=!1;;){u.GetTransform(K.s_xfA,q);m.GetTransform(K.s_xfB,q);K.s_distanceInput.proxyA=
b;K.s_distanceInput.proxyB=c;K.s_distanceInput.transformA=K.s_xfA;K.s_distanceInput.transformB=K.s_xfB;w.Distance(K.s_distanceOutput,K.s_cache,K.s_distanceInput);if(0>=K.s_distanceOutput.distance){q=1;break}K.s_fcn.Initialize(K.s_cache,b,K.s_xfA,c,K.s_xfB);var y=K.s_fcn.Evaluate(K.s_xfA,K.s_xfB);if(0>=y){q=1;break}0==h&&(t=y>d?e.Max(d-a,0.75*d):e.Max(y-a,0.02*d));if(y-t<0.5*a){if(0==h){q=1;break}break}var g=q,J=q,k=1;u.GetTransform(K.s_xfA,k);m.GetTransform(K.s_xfB,k);var B=K.s_fcn.Evaluate(K.s_xfA,
K.s_xfB);if(B>=t){q=1;break}for(var r=0;;){var O=0,O=r&1?J+(t-y)*(k-J)/(B-y):0.5*(J+k);u.GetTransform(K.s_xfA,O);m.GetTransform(K.s_xfB,O);var P=K.s_fcn.Evaluate(K.s_xfA,K.s_xfB);if(e.Abs(P-t)<0.025*a){g=O;break}P>t?(J=O,y=P):(k=O,B=P);++r;++K.b2_toiRootIters;if(50==r)break}K.b2_toiMaxRootIters=e.Max(K.b2_toiMaxRootIters,r);if(g<(1+100*Number.MIN_VALUE)*q)break;q=g;h++;++K.b2_toiIters;if(1E3==h)break}K.b2_toiMaxIters=e.Max(K.b2_toiMaxIters,h);return q};Box2D.postDefs.push(function(){Box2D.Collision.b2TimeOfImpact.b2_toiCalls=
0;Box2D.Collision.b2TimeOfImpact.b2_toiIters=0;Box2D.Collision.b2TimeOfImpact.b2_toiMaxIters=0;Box2D.Collision.b2TimeOfImpact.b2_toiRootIters=0;Box2D.Collision.b2TimeOfImpact.b2_toiMaxRootIters=0;Box2D.Collision.b2TimeOfImpact.s_cache=new B;Box2D.Collision.b2TimeOfImpact.s_distanceInput=new F;Box2D.Collision.b2TimeOfImpact.s_xfA=new g;Box2D.Collision.b2TimeOfImpact.s_xfB=new g;Box2D.Collision.b2TimeOfImpact.s_fcn=new q;Box2D.Collision.b2TimeOfImpact.s_distanceOutput=new r});P.b2TOIInput=function(){this.proxyA=
new E;this.proxyB=new E;this.sweepA=new d;this.sweepB=new d};O.b2WorldManifold=function(){this.m_normal=new h};O.prototype.b2WorldManifold=function(){this.m_points=new Vector(f.b2_maxManifoldPoints);for(var a=0;a<f.b2_maxManifoldPoints;a++)this.m_points[a]=new h};O.prototype.Initialize=function(a,b,c,f,e){void 0===c&&(c=0);void 0===e&&(e=0);if(0!=a.m_pointCount){var u=0,m,d,q=0,h=0,t=0,y=0,g=0;switch(a.m_type){case C.e_circles:d=b.R;m=a.m_localPoint;u=b.position.x+d.col1.x*m.x+d.col2.x*m.y;b=b.position.y+
d.col1.y*m.x+d.col2.y*m.y;d=f.R;m=a.m_points[0].m_localPoint;a=f.position.x+d.col1.x*m.x+d.col2.x*m.y;f=f.position.y+d.col1.y*m.x+d.col2.y*m.y;m=a-u;d=f-b;q=m*m+d*d;q>Number.MIN_VALUE*Number.MIN_VALUE?(q=Math.sqrt(q),this.m_normal.x=m/q,this.m_normal.y=d/q):(this.m_normal.x=1,this.m_normal.y=0);m=b+c*this.m_normal.y;f-=e*this.m_normal.y;this.m_points[0].x=0.5*(u+c*this.m_normal.x+(a-e*this.m_normal.x));this.m_points[0].y=0.5*(m+f);break;case C.e_faceA:d=b.R;m=a.m_localPlaneNormal;q=d.col1.x*m.x+d.col2.x*
m.y;h=d.col1.y*m.x+d.col2.y*m.y;d=b.R;m=a.m_localPoint;t=b.position.x+d.col1.x*m.x+d.col2.x*m.y;y=b.position.y+d.col1.y*m.x+d.col2.y*m.y;this.m_normal.x=q;this.m_normal.y=h;for(u=0;u<a.m_pointCount;u++)d=f.R,m=a.m_points[u].m_localPoint,g=f.position.x+d.col1.x*m.x+d.col2.x*m.y,m=f.position.y+d.col1.y*m.x+d.col2.y*m.y,this.m_points[u].x=g+0.5*(c-(g-t)*q-(m-y)*h-e)*q,this.m_points[u].y=m+0.5*(c-(g-t)*q-(m-y)*h-e)*h;break;case C.e_faceB:d=f.R;m=a.m_localPlaneNormal;q=d.col1.x*m.x+d.col2.x*m.y;h=d.col1.y*
m.x+d.col2.y*m.y;d=f.R;m=a.m_localPoint;t=f.position.x+d.col1.x*m.x+d.col2.x*m.y;y=f.position.y+d.col1.y*m.x+d.col2.y*m.y;this.m_normal.x=-q;this.m_normal.y=-h;for(u=0;u<a.m_pointCount;u++)d=b.R,m=a.m_points[u].m_localPoint,g=b.position.x+d.col1.x*m.x+d.col2.x*m.y,m=b.position.y+d.col1.y*m.x+d.col2.y*m.y,this.m_points[u].x=g+0.5*(e-(g-t)*q-(m-y)*h-c)*q,this.m_points[u].y=m+0.5*(e-(g-t)*q-(m-y)*h-c)*h}}};u.ClipVertex=function(){this.v=new h;this.id=new x};u.prototype.Set=function(a){this.v.SetV(a.v);
this.id.Set(a.id)};m.Features=function(){};Object.defineProperty(m.prototype,"referenceEdge",{enumerable:!1,configurable:!0,get:function(){return this._referenceEdge}});Object.defineProperty(m.prototype,"referenceEdge",{enumerable:!1,configurable:!0,set:function(a){void 0===a&&(a=0);this._referenceEdge=a;this._m_id._key=this._m_id._key&4294967040|this._referenceEdge&255}});Object.defineProperty(m.prototype,"incidentEdge",{enumerable:!1,configurable:!0,get:function(){return this._incidentEdge}});Object.defineProperty(m.prototype,
"incidentEdge",{enumerable:!1,configurable:!0,set:function(a){void 0===a&&(a=0);this._incidentEdge=a;this._m_id._key=this._m_id._key&4294902015|this._incidentEdge<<8&65280}});Object.defineProperty(m.prototype,"incidentVertex",{enumerable:!1,configurable:!0,get:function(){return this._incidentVertex}});Object.defineProperty(m.prototype,"incidentVertex",{enumerable:!1,configurable:!0,set:function(a){void 0===a&&(a=0);this._incidentVertex=a;this._m_id._key=this._m_id._key&4278255615|this._incidentVertex<<
16&16711680}});Object.defineProperty(m.prototype,"flip",{enumerable:!1,configurable:!0,get:function(){return this._flip}});Object.defineProperty(m.prototype,"flip",{enumerable:!1,configurable:!0,set:function(a){void 0===a&&(a=0);this._flip=a;this._m_id._key=this._m_id._key&16777215|this._flip<<24&4278190080}})})();
(function(){var b=Box2D.Common.b2Settings,c=Box2D.Collision.Shapes.b2CircleShape,a=Box2D.Collision.Shapes.b2EdgeChainDef,f=Box2D.Collision.Shapes.b2EdgeShape,e=Box2D.Collision.Shapes.b2MassData,d=Box2D.Collision.Shapes.b2PolygonShape,g=Box2D.Collision.Shapes.b2Shape,h=Box2D.Common.Math.b2Mat22,k=Box2D.Common.Math.b2Math,l=Box2D.Common.Math.b2Transform,p=Box2D.Common.Math.b2Vec2,s=Box2D.Collision.b2Distance,x=Box2D.Collision.b2DistanceInput,v=Box2D.Collision.b2DistanceOutput,w=Box2D.Collision.b2DistanceProxy,
F=Box2D.Collision.b2SimplexCache;Box2D.inherit(c,Box2D.Collision.Shapes.b2Shape);c.prototype.__super=Box2D.Collision.Shapes.b2Shape.prototype;c.b2CircleShape=function(){Box2D.Collision.Shapes.b2Shape.b2Shape.apply(this,arguments);this.m_p=new p};c.prototype.Copy=function(){var a=new c;a.Set(this);return a};c.prototype.Set=function(a){this.__super.Set.call(this,a);Box2D.is(a,c)&&this.m_p.SetV((a instanceof c?a:null).m_p)};c.prototype.TestPoint=function(a,b){var c=a.R,f=a.position.x+(c.col1.x*this.m_p.x+
...
Box2D.Collision.Shapes.b2Shape.prototype;f.b2EdgeShape=function(){Box2D.Collision.Shapes.b2Shape.b2Shape.apply(this,arguments);this.s_supportVec=new p;this.m_v1=new p;this.m_v2=new p;this.m_coreV1=new p;this.m_coreV2=new p;this.m_normal=new p;this.m_direction=new p;this.m_cornerDir1=new p;this.m_cornerDir2=new p};f.prototype.TestPoint=function(){return!1};f.prototype.RayCast=function(a,c,b){var f,e=c.p2.x-c.p1.x,d=c.p2.y-c.p1.y;f=b.R;var h=b.position.x+(f.col1.x*this.m_v1.x+f.col2.x*this.m_v1.y),
...
return!0};d.prototype.RayCast=function(a,b,c){var f=0,e=b.maxFraction,d=0,h=0,g,k,d=b.p1.x-c.position.x,h=b.p1.y-c.position.y;g=c.R;var l=d*g.col1.x+h*g.col1.y,s=d*g.col2.x+h*g.col2.y,d=b.p2.x-c.position.x,h=b.p2.y-c.position.y;g=c.R;b=d*g.col1.x+h*g.col1.y-l;g=d*g.col2.x+h*g.col2.y-s;for(var p=-1,q=0;q<this.m_vertexCount;++q){k=this.m_vertices[q];d=k.x-l;h=k.y-s;k=this.m_normals[q];d=k.x*d+k.y*h;h=k.x*b+k.y*g;if(0==h){if(0>d)return!1}else 0>h&&d<f*h?(f=d/h,p=q):0<h&&d<e*h&&(e=d/h);if(e<f-Number.MIN_VALUE)return!1}return 0<=
p?(a.fraction=f,g=c.R,k=this.m_normals[p],a.normal.x=g.col1.x*k.x+g.col2.x*k.y,a.normal.y=g.col1.y*k.x+g.col2.y*k.y,!0):!1};d.prototype.ComputeAABB=function(a,b){for(var c=b.R,f=this.m_vertices[0],e=b.position.x+(c.col1.x*f.x+c.col2.x*f.y),d=b.position.y+(c.col1.y*f.x+c.col2.y*f.y),h=e,g=d,k=1;k<this.m_vertexCount;++k)var f=this.m_vertices[k],l=b.position.x+(c.col1.x*f.x+c.col2.x*f.y),f=b.position.y+(c.col1.y*f.x+c.col2.y*f.y),e=e<l?e:l,d=d<f?d:f,h=h>l?h:l,g=g>f?g:f;a.lowerBound.x=e-this.m_radius;
a.lowerBound.y=d-this.m_radius;a.upperBound.x=h+this.m_radius;a.upperBound.y=g+this.m_radius};d.prototype.ComputeMass=function(a,b){void 0===b&&(b=0);if(2==this.m_vertexCount)a.center.x=0.5*(this.m_vertices[0].x+this.m_vertices[1].x),a.center.y=0.5*(this.m_vertices[0].y+this.m_vertices[1].y),a.mass=0,a.I=0;else{for(var c=0,f=0,e=0,d=0,h=1/3,g=0;g<this.m_vertexCount;++g)var k=this.m_vertices[g],l=g+1<this.m_vertexCount?this.m_vertices[parseInt(g+1)]:this.m_vertices[0],s=k.x-0,p=k.y-0,q=l.x-0,t=l.y-
0,B=s*t-p*q,y=0.5*B,e=e+y,c=c+y*h*(0+k.x+l.x),f=f+y*h*(0+k.y+l.y),k=s,d=d+B*(h*(0.25*(k*k+q*k+q*q)+(0*k+0*q))+0+(h*(0.25*(p*p+t*p+t*t)+(0*p+0*t))+0));a.mass=b*e;a.center.Set(c*(1/e),f*(1/e));a.I=b*d}};d.prototype.ComputeSubmergedArea=function(a,b,c,f){void 0===b&&(b=0);var d=k.MulTMV(c.R,a),h=b-k.Dot(a,c.position),g=new Vector_a2j_Number,l=0,s=-1;b=-1;var x=!1;for(a=a=0;a<this.m_vertexCount;++a){g[a]=k.Dot(d,this.m_vertices[a])-h;var v=g[a]<-Number.MIN_VALUE;0<a&&(v?x||(s=a-1,l++):x&&(b=a-1,l++));
x=v}switch(l){case 0:return x?(a=new e,this.ComputeMass(a,1),f.SetV(k.MulX(c,a.center)),a.mass):0;case 1:-1==s?s=this.m_vertexCount-1:b=this.m_vertexCount-1}a=parseInt((s+1)%this.m_vertexCount);d=parseInt((b+1)%this.m_vertexCount);h=(0-g[s])/(g[a]-g[s]);g=(0-g[b])/(g[d]-g[b]);s=new p(this.m_vertices[s].x*(1-h)+this.m_vertices[a].x*h,this.m_vertices[s].y*(1-h)+this.m_vertices[a].y*h);b=new p(this.m_vertices[b].x*(1-g)+this.m_vertices[d].x*g,this.m_vertices[b].y*(1-g)+this.m_vertices[d].y*g);g=0;h=
new p;for(l=this.m_vertices[a];a!=d;)a=(a+1)%this.m_vertexCount,x=a==d?b:this.m_vertices[a],v=0.5*((l.x-s.x)*(x.y-s.y)-(l.y-s.y)*(x.x-s.x)),g+=v,h.x+=v*(s.x+l.x+x.x)/3,h.y+=v*(s.y+l.y+x.y)/3,l=x;h.Multiply(1/g);f.SetV(k.MulX(c,h));return g};d.prototype.GetVertexCount=function(){return this.m_vertexCount};d.prototype.GetVertices=function(){return this.m_vertices};d.prototype.GetNormals=function(){return this.m_normals};d.prototype.GetSupport=function(a){for(var b=0,c=this.m_vertices[0].x*a.x+this.m_vertices[0].y*
...
new p;this.m_vertices=new Vector;this.m_normals=new Vector};d.prototype.Reserve=function(a){void 0===a&&(a=0);for(var b=parseInt(this.m_vertices.length);b<a;b++)this.m_vertices[b]=new p,this.m_normals[b]=new p};d.ComputeCentroid=function(a,b){void 0===b&&(b=0);for(var c=new p,f=0,e=1/3,d=0;d<b;++d){var h=a[d],g=d+1<b?a[parseInt(d+1)]:a[0],k=0.5*((h.x-0)*(g.y-0)-(h.y-0)*(g.x-0)),f=f+k;c.x+=k*e*(0+h.x+g.x);c.y+=k*e*(0+h.y+g.y)}c.x*=1/f;c.y*=1/f;return c};d.ComputeOBB=function(a,b,c){void 0===c&&(c=
0);for(var f=0,e=new Vector(c+1),f=0;f<c;++f)e[f]=b[f];e[c]=e[0];b=Number.MAX_VALUE;for(f=1;f<=c;++f){for(var d=e[parseInt(f-1)],h=e[f].x-d.x,g=e[f].y-d.y,k=Math.sqrt(h*h+g*g),h=h/k,g=g/k,l=-g,s=h,p=k=Number.MAX_VALUE,q=-Number.MAX_VALUE,t=-Number.MAX_VALUE,B=0;B<c;++B){var y=e[B].x-d.x,K=e[B].y-d.y,P=h*y+g*K,y=l*y+s*K;P<k&&(k=P);y<p&&(p=y);P>q&&(q=P);y>t&&(t=y)}B=(q-k)*(t-p);B<0.95*b&&(b=B,a.R.col1.x=h,a.R.col1.y=g,a.R.col2.x=l,a.R.col2.y=s,h=0.5*(k+q),g=0.5*(p+t),l=a.R,a.center.x=d.x+(l.col1.x*
h+l.col2.x*g),a.center.y=d.y+(l.col1.y*h+l.col2.y*g),a.extents.x=0.5*(q-k),a.extents.y=0.5*(t-p))}};Box2D.postDefs.push(function(){Box2D.Collision.Shapes.b2PolygonShape.s_mat=new h});g.b2Shape=function(){};g.prototype.Copy=function(){return null};g.prototype.Set=function(a){this.m_radius=a.m_radius};g.prototype.GetType=function(){return this.m_type};g.prototype.TestPoint=function(){return!1};g.prototype.RayCast=function(){return!1};g.prototype.ComputeAABB=function(){};g.prototype.ComputeMass=function(){};
...
d=this.col1.y,g=this.col1.z,w=this.col2.x,F=this.col2.y,r=this.col2.z,E=this.col3.x,A=this.col3.y,z=this.col3.z,D=e*(F*z-r*A)+d*(r*E-w*z)+g*(w*A-F*E);0!=D&&(D=1/D);a.x=D*(b*(F*z-r*A)+c*(r*E-w*z)+f*(w*A-F*E));a.y=D*(e*(c*z-f*A)+d*(f*E-b*z)+g*(b*A-c*E));a.z=D*(e*(F*f-r*c)+d*(r*b-w*f)+g*(w*c-F*b));return a};a.b2Math=function(){};a.IsValid=function(a){void 0===a&&(a=0);return isFinite(a)};a.Dot=function(a,b){return a.x*b.x+a.y*b.y};a.CrossVV=function(a,b){return a.x*b.y-a.y*b.x};a.CrossVF=function(a,
...
function(a){void 0===a&&(a=0);this.m_type!=r.b2_staticBody&&(this.m_angularVelocity=a)};r.prototype.GetAngularVelocity=function(){return this.m_angularVelocity};r.prototype.GetDefinition=function(){var a=new E;a.type=this.GetType();a.allowSleep=(this.m_flags&r.e_allowSleepFlag)==r.e_allowSleepFlag;a.angle=this.GetAngle();a.angularDamping=this.m_angularDamping;a.angularVelocity=this.m_angularVelocity;a.fixedRotation=(this.m_flags&r.e_fixedRotationFlag)==r.e_fixedRotationFlag;a.bullet=(this.m_flags&
...
a&&(a=0);this.m_type==r.b2_dynamicBody&&(!1==this.IsAwake()&&this.SetAwake(!0),this.m_torque+=a)};r.prototype.ApplyImpulse=function(a,b){this.m_type==r.b2_dynamicBody&&(!1==this.IsAwake()&&this.SetAwake(!0),this.m_linearVelocity.x+=this.m_invMass*a.x,this.m_linearVelocity.y+=this.m_invMass*a.y,this.m_angularVelocity+=this.m_invI*((b.x-this.m_sweep.c.x)*a.y-(b.y-this.m_sweep.c.y)*a.x))};r.prototype.Split=function(a){for(var c=this.GetLinearVelocity().Copy(),f=this.GetAngularVelocity(),e=this.GetWorldCenter(),
...
this.SynchronizeFixtures();d.SynchronizeFixtures();return d};r.prototype.Merge=function(a){var b;for(b=a.m_fixtureList;b;){var c=b.m_next;a.m_fixtureCount--;b.m_next=this.m_fixtureList;this.m_fixtureList=b;this.m_fixtureCount++;b.m_body=e;b=c}f.m_fixtureCount=0;var f=this,e=a;f.GetWorldCenter();e.GetWorldCenter();f.GetLinearVelocity().Copy();e.GetLinearVelocity().Copy();f.GetAngularVelocity();e.GetAngularVelocity();f.ResetMassData();this.SynchronizeFixtures()};r.prototype.GetMass=function(){return this.m_mass};
r.prototype.GetInertia=function(){return this.m_I};r.prototype.GetMassData=function(a){a.mass=this.m_mass;a.I=this.m_I;a.center.SetV(this.m_sweep.localCenter)};r.prototype.SetMassData=function(a){d.b2Assert(!1==this.m_world.IsLocked());if(!0!=this.m_world.IsLocked()&&this.m_type==r.b2_dynamicBody){this.m_invI=this.m_I=this.m_invMass=0;this.m_mass=a.mass;0>=this.m_mass&&(this.m_mass=1);this.m_invMass=1/this.m_mass;0<a.I&&0==(this.m_flags&r.e_fixedRotationFlag)&&(this.m_I=a.I-this.m_mass*(a.center.x*
a.center.x+a.center.y*a.center.y),this.m_invI=1/this.m_I);var c=this.m_sweep.c.Copy();this.m_sweep.localCenter.SetV(a.center);this.m_sweep.c0.SetV(b.MulX(this.m_xf,this.m_sweep.localCenter));this.m_sweep.c.SetV(this.m_sweep.c0);this.m_linearVelocity.x+=this.m_angularVelocity*-(this.m_sweep.c.y-c.y);this.m_linearVelocity.y+=this.m_angularVelocity*+(this.m_sweep.c.x-c.x)}};r.prototype.ResetMassData=function(){this.m_invI=this.m_I=this.m_invMass=this.m_mass=0;this.m_sweep.localCenter.SetZero();if(!(this.m_type==
r.b2_staticBody||this.m_type==r.b2_kinematicBody)){for(var a=f.Make(0,0),c=this.m_fixtureList;c;c=c.m_next)if(0!=c.m_density){var e=c.GetMassData();this.m_mass+=e.mass;a.x+=e.center.x*e.mass;a.y+=e.center.y*e.mass;this.m_I+=e.I}0<this.m_mass?(this.m_invMass=1/this.m_mass,a.x*=this.m_invMass,a.y*=this.m_invMass):this.m_invMass=this.m_mass=1;0<this.m_I&&0==(this.m_flags&r.e_fixedRotationFlag)?(this.m_I-=this.m_mass*(a.x*a.x+a.y*a.y),this.m_I*=this.m_inertiaScale,d.b2Assert(0<this.m_I),this.m_invI=1/
this.m_I):this.m_invI=this.m_I=0;c=this.m_sweep.c.Copy();this.m_sweep.localCenter.SetV(a);this.m_sweep.c0.SetV(b.MulX(this.m_xf,this.m_sweep.localCenter));this.m_sweep.c.SetV(this.m_sweep.c0);this.m_linearVelocity.x+=this.m_angularVelocity*-(this.m_sweep.c.y-c.y);this.m_linearVelocity.y+=this.m_angularVelocity*+(this.m_sweep.c.x-c.x)}};r.prototype.GetWorldPoint=function(a){var b=this.m_xf.R;a=new f(b.col1.x*a.x+b.col2.x*a.y,b.col1.y*a.x+b.col2.y*a.y);a.x+=this.m_xf.position.x;a.y+=this.m_xf.position.y;
return a};r.prototype.GetWorldVector=function(a){return b.MulMV(this.m_xf.R,a)};r.prototype.GetLocalPoint=function(a){return b.MulXT(this.m_xf,a)};r.prototype.GetLocalVector=function(a){return b.MulTMV(this.m_xf.R,a)};r.prototype.GetLinearVelocityFromWorldPoint=function(a){return new f(this.m_linearVelocity.x-this.m_angularVelocity*(a.y-this.m_sweep.c.y),this.m_linearVelocity.y+this.m_angularVelocity*(a.x-this.m_sweep.c.x))};r.prototype.GetLinearVelocityFromLocalPoint=function(a){var b=this.m_xf.R;
a=new f(b.col1.x*a.x+b.col2.x*a.y,b.col1.y*a.x+b.col2.y*a.y);a.x+=this.m_xf.position.x;a.y+=this.m_xf.position.y;return new f(this.m_linearVelocity.x-this.m_angularVelocity*(a.y-this.m_sweep.c.y),this.m_linearVelocity.y+this.m_angularVelocity*(a.x-this.m_sweep.c.x))};r.prototype.GetLinearDamping=function(){return this.m_linearDamping};r.prototype.SetLinearDamping=function(a){void 0===a&&(a=0);this.m_linearDamping=a};r.prototype.GetAngularDamping=function(){return this.m_angularDamping};r.prototype.SetAngularDamping=
...
0;b<this.m_bodyCount;++b)if(c=this.m_bodies[b],c.GetType()!=r.b2_staticBody){var e=a.dt*c.m_linearVelocity.x,q=a.dt*c.m_linearVelocity.y;e*e+q*q>d.b2_maxTranslationSquared&&(c.m_linearVelocity.Normalize(),c.m_linearVelocity.x*=d.b2_maxTranslation*a.inv_dt,c.m_linearVelocity.y*=d.b2_maxTranslation*a.inv_dt);e=a.dt*c.m_angularVelocity;e*e>d.b2_maxRotationSquared&&(c.m_angularVelocity=0>c.m_angularVelocity?-d.b2_maxRotation*a.inv_dt:d.b2_maxRotation*a.inv_dt);c.m_sweep.c0.SetV(c.m_sweep.c);c.m_sweep.a0=
...
a=new r(a,this);a.m_prev=null;if(a.m_next=this.m_bodyList)this.m_bodyList.m_prev=a;this.m_bodyList=a;++this.m_bodyCount;return a};t.prototype.DestroyBody=function(a){if(!0!=this.IsLocked()){for(var b=a.m_jointList;b;){var c=b,b=b.next;this.m_destructionListener&&this.m_destructionListener.SayGoodbyeJoint(c.joint);this.DestroyJoint(c.joint)}for(b=a.m_controllerList;b;)c=b,b=b.nextController,c.controller.RemoveBody(a);for(b=a.m_contactList;b;)c=b,b=b.next,this.m_contactManager.Destroy(c.contact);a.m_contactList=
...
function(){return this.m_jointList};t.prototype.GetContactList=function(){return this.m_contactList};t.prototype.IsLocked=function(){return 0<(this.m_flags&t.e_locked)};t.prototype.Solve=function(a){for(var b,c=this.m_controllerList;c;c=c.m_next)c.Step(a);c=this.m_island;c.Initialize(this.m_bodyCount,this.m_contactCount,this.m_jointCount,null,this.m_contactManager.m_contactListener,this.m_contactSolver);for(b=this.m_bodyList;b;b=b.m_next)b.m_flags&=~r.e_islandFlag;for(var f=this.m_contactList;f;f=
f.m_next)f.m_flags&=~B.e_islandFlag;for(f=this.m_jointList;f;f=f.m_next)f.m_islandFlag=!1;parseInt(this.m_bodyCount);for(var f=this.s_stack,e=this.m_bodyList;e;e=e.m_next)if(!(e.m_flags&r.e_islandFlag)&&!(!1==e.IsAwake()||!1==e.IsActive())&&e.GetType()!=r.b2_staticBody){c.Clear();var d=0;f[d++]=e;for(e.m_flags|=r.e_islandFlag;0<d;)if(b=f[--d],c.AddBody(b),!1==b.IsAwake()&&b.SetAwake(!0),b.GetType()!=r.b2_staticBody){for(var q,g=b.m_contactList;g;g=g.next)if(!(g.contact.m_flags&B.e_islandFlag)&&!(!0==
g.contact.IsSensor()||!1==g.contact.IsEnabled()||!1==g.contact.IsTouching()))c.AddContact(g.contact),g.contact.m_flags|=B.e_islandFlag,q=g.other,q.m_flags&r.e_islandFlag||(f[d++]=q,q.m_flags|=r.e_islandFlag);for(b=b.m_jointList;b;b=b.next)!0!=b.joint.m_islandFlag&&(q=b.other,!1!=q.IsActive()&&(c.AddJoint(b.joint),b.joint.m_islandFlag=!0,q.m_flags&r.e_islandFlag||(f[d++]=q,q.m_flags|=r.e_islandFlag)))}c.Solve(a,this.m_gravity,this.m_allowSleep);for(d=0;d<c.m_bodyCount;++d)b=c.m_bodies[d],b.GetType()==
r.b2_staticBody&&(b.m_flags&=~r.e_islandFlag)}for(d=0;d<f.length&&f[d];++d)f[d]=null;for(b=this.m_bodyList;b;b=b.m_next)!1==b.IsAwake()||!1==b.IsActive()||b.GetType()!=r.b2_staticBody&&b.SynchronizeFixtures();this.m_contactManager.FindNewContacts()};t.prototype.SolveTOI=function(a){var b,c,f,e=this.m_island;e.Initialize(this.m_bodyCount,d.b2_maxTOIContactsPerIsland,d.b2_maxTOIJointsPerIsland,null,this.m_contactManager.m_contactListener,this.m_contactSolver);var q=t.s_queue;for(b=this.m_bodyList;b;b=
b.m_next)b.m_flags&=~r.e_islandFlag,b.m_sweep.t0=0;for(f=this.m_contactList;f;f=f.m_next)f.m_flags&=~(B.e_toiFlag|B.e_islandFlag);for(f=this.m_jointList;f;f=f.m_next)f.m_islandFlag=!1;for(;;){var g=null,y=1;for(f=this.m_contactList;f;f=f.m_next)if(!(!0==f.IsSensor()||!1==f.IsEnabled()||!1==f.IsContinuous())){if(f.m_flags&B.e_toiFlag)b=f.m_toi;else{b=f.m_fixtureA;c=f.m_fixtureB;b=b.m_body;c=c.m_body;if((b.GetType()!=r.b2_dynamicBody||!1==b.IsAwake())&&(c.GetType()!=r.b2_dynamicBody||!1==c.IsAwake()))continue;
...
b(a,this.m_allocator)};p.b2ContactRegister=function(){};s.b2ContactResult=function(){this.position=new G;this.normal=new G;this.id=new N};x.b2ContactSolver=function(){this.m_step=new D;this.m_constraints=new Vector};x.prototype.b2ContactSolver=function(){};x.prototype.Initialize=function(a,b,c,f){void 0===c&&(c=0);var e;this.m_step.Set(a);this.m_allocator=f;for(this.m_constraintCount=c;this.m_constraints.length<this.m_constraintCount;)this.m_constraints[this.m_constraints.length]=new g;for(a=0;a<
c;++a){e=b[a];f=e.m_fixtureA;var d=e.m_fixtureB,q=f.m_shape.m_radius,t=d.m_shape.m_radius,h=f.m_body,B=d.m_body,k=e.GetManifold(),r=H.b2MixFriction(f.GetFriction(),d.GetFriction()),s=H.b2MixRestitution(f.GetRestitution(),d.GetRestitution()),l=h.m_linearVelocity.x,p=h.m_linearVelocity.y,v=B.m_linearVelocity.x,w=B.m_linearVelocity.y,A=h.m_angularVelocity,F=B.m_angularVelocity;H.b2Assert(0<k.m_pointCount);x.s_worldManifold.Initialize(k,h.m_xf,q,B.m_xf,t);d=x.s_worldManifold.m_normal.x;e=x.s_worldManifold.m_normal.y;
f=this.m_constraints[a];f.bodyA=h;f.bodyB=B;f.manifold=k;f.normal.x=d;f.normal.y=e;f.pointCount=k.m_pointCount;f.friction=r;f.restitution=s;f.localPlaneNormal.x=k.m_localPlaneNormal.x;f.localPlaneNormal.y=k.m_localPlaneNormal.y;f.localPoint.x=k.m_localPoint.x;f.localPoint.y=k.m_localPoint.y;f.radius=q+t;f.type=k.m_type;for(q=0;q<f.pointCount;++q){r=k.m_points[q];t=f.points[q];t.normalImpulse=r.m_normalImpulse;t.tangentImpulse=r.m_tangentImpulse;t.localPoint.SetV(r.m_localPoint);var r=t.rA.x=x.s_worldManifold.m_points[q].x-
h.m_sweep.c.x,s=t.rA.y=x.s_worldManifold.m_points[q].y-h.m_sweep.c.y,D=t.rB.x=x.s_worldManifold.m_points[q].x-B.m_sweep.c.x,C=t.rB.y=x.s_worldManifold.m_points[q].y-B.m_sweep.c.y,E=r*e-s*d,z=D*e-C*d,E=E*E,z=z*z;t.normalMass=1/(h.m_invMass+B.m_invMass+h.m_invI*E+B.m_invI*z);var G=h.m_mass*h.m_invMass+B.m_mass*B.m_invMass,G=G+(h.m_mass*h.m_invI*E+B.m_mass*B.m_invI*z);t.equalizedMass=1/G;z=e;G=-d;E=r*G-s*z;z=D*G-C*z;E*=E;z*=z;t.tangentMass=1/(h.m_invMass+B.m_invMass+h.m_invI*E+B.m_invI*z);t.velocityBias=
0;r=f.normal.x*(v+-F*C-l- -A*s)+f.normal.y*(w+F*D-p-A*r);r<-H.b2_velocityThreshold&&(t.velocityBias+=-f.restitution*r)}2==f.pointCount&&(w=f.points[0],v=f.points[1],k=h.m_invMass,h=h.m_invI,l=B.m_invMass,B=B.m_invI,p=w.rA.x*e-w.rA.y*d,w=w.rB.x*e-w.rB.y*d,A=v.rA.x*e-v.rA.y*d,v=v.rB.x*e-v.rB.y*d,d=k+l+h*p*p+B*w*w,e=k+l+h*A*A+B*v*v,B=k+l+h*p*A+B*w*v,d*d<100*(d*e-B*B)?(f.K.col1.Set(d,B),f.K.col2.Set(B,e),f.K.GetInverse(f.normalMass)):f.pointCount=1)}};x.prototype.InitVelocityConstraints=function(a){for(var b=
0;b<this.m_constraintCount;++b){var c=this.m_constraints[b],f=c.bodyA,e=c.bodyB,d=f.m_invMass,q=f.m_invI,g=e.m_invMass,t=e.m_invI,h=c.normal.x,B=c.normal.y,k=B,r=-h,s=0,l=0;if(a.warmStarting){l=c.pointCount;for(s=0;s<l;++s){var p=c.points[s];p.normalImpulse*=a.dtRatio;p.tangentImpulse*=a.dtRatio;var v=p.normalImpulse*h+p.tangentImpulse*k,x=p.normalImpulse*B+p.tangentImpulse*r;f.m_angularVelocity-=q*(p.rA.x*x-p.rA.y*v);f.m_linearVelocity.x-=d*v;f.m_linearVelocity.y-=d*x;e.m_angularVelocity+=t*(p.rB.x*
x-p.rB.y*v);e.m_linearVelocity.x+=g*v;e.m_linearVelocity.y+=g*x}}else{l=c.pointCount;for(s=0;s<l;++s)f=c.points[s],f.normalImpulse=0,f.tangentImpulse=0}}};x.prototype.SolveVelocityConstraints=function(){for(var a=0,b,c=0,f=0,e=0,d=0,q=0,g=0,t=0,h,B=0;B<this.m_constraintCount;++B){var e=this.m_constraints[B],k=e.bodyA,r=e.bodyB,s=k.m_angularVelocity,l=r.m_angularVelocity,p=k.m_linearVelocity,v=r.m_linearVelocity,x=k.m_invMass,w=k.m_invI,A=r.m_invMass,F=r.m_invI,g=e.normal.x,z=t=e.normal.y;h=-g;q=e.friction;
for(a=0;a<e.pointCount;a++)b=e.points[a],c=v.x-l*b.rB.y-p.x+s*b.rA.y,f=v.y+l*b.rB.x-p.y-s*b.rA.x,c=c*z+f*h,c=b.tangentMass*-c,f=q*b.normalImpulse,f=M.Clamp(b.tangentImpulse+c,-f,f),c=f-b.tangentImpulse,d=c*z,c*=h,p.x-=x*d,p.y-=x*c,s-=w*(b.rA.x*c-b.rA.y*d),v.x+=A*d,v.y+=A*c,l+=F*(b.rB.x*c-b.rB.y*d),b.tangentImpulse=f;parseInt(e.pointCount);if(1==e.pointCount)b=e.points[0],c=v.x+-l*b.rB.y-p.x- -s*b.rA.y,f=v.y+l*b.rB.x-p.y-s*b.rA.x,e=c*g+f*t,c=-b.normalMass*(e-b.velocityBias),f=b.normalImpulse+c,f=0<
f?f:0,c=f-b.normalImpulse,d=c*g,c*=t,p.x-=x*d,p.y-=x*c,s-=w*(b.rA.x*c-b.rA.y*d),v.x+=A*d,v.y+=A*c,l+=F*(b.rB.x*c-b.rB.y*d),b.normalImpulse=f;else{b=e.points[0];var a=e.points[1],c=b.normalImpulse,q=a.normalImpulse,D=(v.x-l*b.rB.y-p.x+s*b.rA.y)*g+(v.y+l*b.rB.x-p.y-s*b.rA.x)*t,E=(v.x-l*a.rB.y-p.x+s*a.rA.y)*g+(v.y+l*a.rB.x-p.y-s*a.rA.x)*t,f=D-b.velocityBias,d=E-a.velocityBias;h=e.K;f-=h.col1.x*c+h.col2.x*q;for(d-=h.col1.y*c+h.col2.y*q;;){h=e.normalMass;z=-(h.col1.x*f+h.col2.x*d);h=-(h.col1.y*f+h.col2.y*
d);if(0<=z&&0<=h){c=z-c;q=h-q;e=c*g;c*=t;g*=q;t*=q;p.x-=x*(e+g);p.y-=x*(c+t);s-=w*(b.rA.x*c-b.rA.y*e+a.rA.x*t-a.rA.y*g);v.x+=A*(e+g);v.y+=A*(c+t);l+=F*(b.rB.x*c-b.rB.y*e+a.rB.x*t-a.rB.y*g);b.normalImpulse=z;a.normalImpulse=h;break}z=-b.normalMass*f;h=0;E=e.K.col1.y*z+d;if(0<=z&&0<=E){c=z-c;q=h-q;e=c*g;c*=t;g*=q;t*=q;p.x-=x*(e+g);p.y-=x*(c+t);s-=w*(b.rA.x*c-b.rA.y*e+a.rA.x*t-a.rA.y*g);v.x+=A*(e+g);v.y+=A*(c+t);l+=F*(b.rB.x*c-b.rB.y*e+a.rB.x*t-a.rB.y*g);b.normalImpulse=z;a.normalImpulse=h;break}z=0;
h=-a.normalMass*d;D=e.K.col2.x*h+f;if(0<=h&&0<=D){c=z-c;q=h-q;e=c*g;c*=t;g*=q;t*=q;p.x-=x*(e+g);p.y-=x*(c+t);s-=w*(b.rA.x*c-b.rA.y*e+a.rA.x*t-a.rA.y*g);v.x+=A*(e+g);v.y+=A*(c+t);l+=F*(b.rB.x*c-b.rB.y*e+a.rB.x*t-a.rB.y*g);b.normalImpulse=z;a.normalImpulse=h;break}h=z=0;D=f;E=d;if(0<=D&&0<=E){c=z-c;q=h-q;e=c*g;c*=t;g*=q;t*=q;p.x-=x*(e+g);p.y-=x*(c+t);s-=w*(b.rA.x*c-b.rA.y*e+a.rA.x*t-a.rA.y*g);v.x+=A*(e+g);v.y+=A*(c+t);l+=F*(b.rB.x*c-b.rB.y*e+a.rB.x*t-a.rB.y*g);b.normalImpulse=z;a.normalImpulse=h;break}break}}k.m_angularVelocity=
s;r.m_angularVelocity=l}};x.prototype.FinalizeVelocityConstraints=function(){for(var a=0;a<this.m_constraintCount;++a)for(var b=this.m_constraints[a],c=b.manifold,f=0;f<b.pointCount;++f){var e=c.m_points[f],d=b.points[f];e.m_normalImpulse=d.normalImpulse;e.m_tangentImpulse=d.tangentImpulse}};x.prototype.SolvePositionConstraints=function(a){void 0===a&&(a=0);for(var b=0,c=0;c<this.m_constraintCount;c++){var f=this.m_constraints[c],e=f.bodyA,d=f.bodyB,q=e.m_mass*e.m_invMass,g=e.m_mass*e.m_invI,t=d.m_mass*
d.m_invMass,h=d.m_mass*d.m_invI;x.s_psm.Initialize(f);for(var B=x.s_psm.m_normal,k=0;k<f.pointCount;k++){var r=f.points[k],s=x.s_psm.m_points[k],p=x.s_psm.m_separations[k],l=s.x-e.m_sweep.c.x,v=s.y-e.m_sweep.c.y,w=s.x-d.m_sweep.c.x,s=s.y-d.m_sweep.c.y,b=b<p?b:p,p=M.Clamp(a*(p+H.b2_linearSlop),-H.b2_maxLinearCorrection,0),p=-r.equalizedMass*p,r=p*B.x,p=p*B.y;e.m_sweep.c.x-=q*r;e.m_sweep.c.y-=q*p;e.m_sweep.a-=g*(l*p-v*r);e.SynchronizeTransform();d.m_sweep.c.x+=t*r;d.m_sweep.c.y+=t*p;d.m_sweep.a+=h*
(w*p-s*r);d.SynchronizeTransform()}}return b>-1.5*H.b2_linearSlop};Box2D.postDefs.push(function(){Box2D.Dynamics.Contacts.b2ContactSolver.s_worldManifold=new B;Box2D.Dynamics.Contacts.b2ContactSolver.s_psm=new A});Box2D.inherit(v,Box2D.Dynamics.Contacts.b2Contact);v.prototype.__super=Box2D.Dynamics.Contacts.b2Contact.prototype;v.b2EdgeAndCircleContact=function(){Box2D.Dynamics.Contacts.b2Contact.b2Contact.apply(this,arguments)};v.Create=function(){return new v};v.Destroy=function(){};v.prototype.Reset=
...
b.nextBody){var c=b.body;if(!1!=c.IsAwake()){for(var f=new a,e=new a,d=0,g=0,h=c.GetFixtureList();h;h=h.GetNext()){var k=new a,p=h.GetShape().ComputeSubmergedArea(this.normal,this.offset,c.GetTransform(),k),d=d+p;f.x+=p*k.x;f.y+=p*k.y;var l=0,l=1,g=g+p*l;e.x+=p*k.x*l;e.y+=p*k.y*l}f.x/=d;f.y/=d;e.x/=g;e.y/=g;d<Number.MIN_VALUE||(g=this.gravity.GetNegative(),g.Multiply(this.density*d),c.ApplyForce(g,e),e=c.GetLinearVelocityFromWorldPoint(f),e.Subtract(this.velocity),e.Multiply(-this.linearDrag*d),c.ApplyForce(e,
...
l.b2GravityController=function(){Box2D.Dynamics.Controllers.b2Controller.b2Controller.apply(this,arguments);this.G=1;this.invSqr=!0};l.prototype.Step=function(){var b=null,c=null,f=null,e=0,d=null,g=null,h=null,k=0,p=0,l=0;if(this.invSqr)for(b=this.m_bodyList;b;b=b.nextBody){c=b.body;f=c.GetWorldCenter();e=c.GetMass();for(d=this.m_bodyList;d!=b;d=d.nextBody)g=d.body,h=g.GetWorldCenter(),k=h.x-f.x,p=h.y-f.y,l=k*k+p*p,l<Number.MIN_VALUE||(k=new a(k,p),k.Multiply(this.G/l/Math.sqrt(l)*e*g.GetMass()),
c.IsAwake()&&c.ApplyForce(k,f),k.Multiply(-1),g.IsAwake()&&g.ApplyForce(k,h))}else for(b=this.m_bodyList;b;b=b.nextBody){c=b.body;f=c.GetWorldCenter();e=c.GetMass();for(d=this.m_bodyList;d!=b;d=d.nextBody)g=d.body,h=g.GetWorldCenter(),k=h.x-f.x,p=h.y-f.y,l=k*k+p*p,l<Number.MIN_VALUE||(k=new a(k,p),k.Multiply(this.G/l*e*g.GetMass()),c.IsAwake()&&c.ApplyForce(k,f),k.Multiply(-1),g.IsAwake()&&g.ApplyForce(k,h))}};Box2D.inherit(p,Box2D.Dynamics.Controllers.b2Controller);p.prototype.__super=Box2D.Dynamics.Controllers.b2Controller.prototype;
p.b2TensorDampingController=function(){Box2D.Dynamics.Controllers.b2Controller.b2Controller.apply(this,arguments);this.T=new b;this.maxTimestep=0};p.prototype.SetAxisAligned=function(a,b){void 0===a&&(a=0);void 0===b&&(b=0);this.T.col1.x=-a;this.T.col1.y=0;this.T.col2.x=0;this.T.col2.y=-b;this.maxTimestep=0<a||0<b?1/Math.max(a,b):0};p.prototype.Step=function(b){b=b.dt;if(!(b<=Number.MIN_VALUE)){b>this.maxTimestep&&0<this.maxTimestep&&(b=this.maxTimestep);for(var f=this.m_bodyList;f;f=f.nextBody){var e=
...
f=c.col1.x*g+c.col2.x*h,h=c.col1.y*g+c.col2.y*h,g=f;c=d.m_xf.R;var k=this.m_localAnchor2.x-d.m_sweep.localCenter.x,m=this.m_localAnchor2.y-d.m_sweep.localCenter.y,f=c.col1.x*k+c.col2.x*m,m=c.col1.y*k+c.col2.y*m,k=f;this.m_u.x=d.m_sweep.c.x+k-e.m_sweep.c.x-g;this.m_u.y=d.m_sweep.c.y+m-e.m_sweep.c.y-h;f=Math.sqrt(this.m_u.x*this.m_u.x+this.m_u.y*this.m_u.y);f>b.b2_linearSlop?this.m_u.Multiply(1/f):this.m_u.SetZero();c=g*this.m_u.y-h*this.m_u.x;var p=k*this.m_u.y-m*this.m_u.x;c=e.m_invMass+e.m_invI*
c*c+d.m_invMass+d.m_invI*p*p;this.m_mass=0!=c?1/c:0;if(0<this.m_frequencyHz){var f=f-this.m_length,p=2*Math.PI*this.m_frequencyHz,r=this.m_mass*p*p;this.m_gamma=a.dt*(2*this.m_mass*this.m_dampingRatio*p+a.dt*r);this.m_gamma=0!=this.m_gamma?1/this.m_gamma:0;this.m_bias=f*a.dt*r*this.m_gamma;this.m_mass=c+this.m_gamma;this.m_mass=0!=this.m_mass?1/this.m_mass:0}a.warmStarting?(this.m_impulse*=a.dtRatio,a=this.m_impulse*this.m_u.x,c=this.m_impulse*this.m_u.y,e.m_linearVelocity.x-=e.m_invMass*a,e.m_linearVelocity.y-=
e.m_invMass*c,e.m_angularVelocity-=e.m_invI*(g*c-h*a),d.m_linearVelocity.x+=d.m_invMass*a,d.m_linearVelocity.y+=d.m_invMass*c,d.m_angularVelocity+=d.m_invI*(k*c-m*a)):this.m_impulse=0};g.prototype.SolveVelocityConstraints=function(){var a,b=this.m_bodyA,c=this.m_bodyB;a=b.m_xf.R;var f=this.m_localAnchor1.x-b.m_sweep.localCenter.x,e=this.m_localAnchor1.y-b.m_sweep.localCenter.y,d=a.col1.x*f+a.col2.x*e,e=a.col1.y*f+a.col2.y*e,f=d;a=c.m_xf.R;var g=this.m_localAnchor2.x-c.m_sweep.localCenter.x,h=this.m_localAnchor2.y-
...
u,u=a.col1.y*k+a.col2.y*u,k=h,h=e.m_sweep.c.x+k-c.m_sweep.c.x-d,m=e.m_sweep.c.y+u-c.m_sweep.c.y-g;a=Math.sqrt(h*h+m*m);h/=a;m/=a;a-=this.m_length;a=f.Clamp(a,-b.b2_maxLinearCorrection,b.b2_maxLinearCorrection);var p=-this.m_mass*a;this.m_u.Set(h,m);h=p*this.m_u.x;m=p*this.m_u.y;c.m_sweep.c.x-=c.m_invMass*h;c.m_sweep.c.y-=c.m_invMass*m;c.m_sweep.a-=c.m_invI*(d*m-g*h);e.m_sweep.c.x+=e.m_invMass*h;e.m_sweep.c.y+=e.m_invMass*m;e.m_sweep.a+=e.m_invI*(k*m-u*h);c.SynchronizeTransform();e.SynchronizeTransform();
...
f=0,e=this.m_bodyA,d=this.m_bodyB;b=e.m_xf.R;var g=this.m_localAnchorA.x-e.m_sweep.localCenter.x,h=this.m_localAnchorA.y-e.m_sweep.localCenter.y,f=b.col1.x*g+b.col2.x*h,h=b.col1.y*g+b.col2.y*h,g=f;b=d.m_xf.R;var k=this.m_localAnchorB.x-d.m_sweep.localCenter.x,m=this.m_localAnchorB.y-d.m_sweep.localCenter.y,f=b.col1.x*k+b.col2.x*m,m=b.col1.y*k+b.col2.y*m,k=f;b=e.m_invMass;var f=d.m_invMass,p=e.m_invI,r=d.m_invI,l=new c;l.col1.x=b+f;l.col2.x=0;l.col1.y=0;l.col2.y=b+f;l.col1.x+=p*h*h;l.col2.x+=-p*g*
h;l.col1.y+=-p*g*h;l.col2.y+=p*g*g;l.col1.x+=r*m*m;l.col2.x+=-r*k*m;l.col1.y+=-r*k*m;l.col2.y+=r*k*k;l.GetInverse(this.m_linearMass);this.m_angularMass=p+r;0<this.m_angularMass&&(this.m_angularMass=1/this.m_angularMass);a.warmStarting?(this.m_linearImpulse.x*=a.dtRatio,this.m_linearImpulse.y*=a.dtRatio,this.m_angularImpulse*=a.dtRatio,a=this.m_linearImpulse,e.m_linearVelocity.x-=b*a.x,e.m_linearVelocity.y-=b*a.y,e.m_angularVelocity-=p*(g*a.y-h*a.x+this.m_angularImpulse),d.m_linearVelocity.x+=f*a.x,
d.m_linearVelocity.y+=f*a.y,d.m_angularVelocity+=r*(k*a.y-m*a.x+this.m_angularImpulse)):(this.m_linearImpulse.SetZero(),this.m_angularImpulse=0)};k.prototype.SolveVelocityConstraints=function(a){var b,c=0,d=this.m_bodyA,g=this.m_bodyB,h=d.m_linearVelocity,k=d.m_angularVelocity,u=g.m_linearVelocity,m=g.m_angularVelocity,p=d.m_invMass,l=g.m_invMass,r=d.m_invI,s=g.m_invI;b=d.m_xf.R;var v=this.m_localAnchorA.x-d.m_sweep.localCenter.x,x=this.m_localAnchorA.y-d.m_sweep.localCenter.y,c=b.col1.x*v+b.col2.x*
x,x=b.col1.y*v+b.col2.y*x,v=c;b=g.m_xf.R;var w=this.m_localAnchorB.x-g.m_sweep.localCenter.x,z=this.m_localAnchorB.y-g.m_sweep.localCenter.y,c=b.col1.x*w+b.col2.x*z,z=b.col1.y*w+b.col2.y*z,w=c,c=-this.m_angularMass*(m-k),A=this.m_angularImpulse;b=a.dt*this.m_maxTorque;this.m_angularImpulse=f.Clamp(this.m_angularImpulse+c,-b,b);c=this.m_angularImpulse-A;k-=r*c;m+=s*c;b=f.MulMV(this.m_linearMass,new e(-(u.x-m*z-h.x+k*x),-(u.y+m*w-h.y-k*v)));c=this.m_linearImpulse.Copy();this.m_linearImpulse.Add(b);
b=a.dt*this.m_maxForce;this.m_linearImpulse.LengthSquared()>b*b&&(this.m_linearImpulse.Normalize(),this.m_linearImpulse.Multiply(b));b=f.SubtractVV(this.m_linearImpulse,c);h.x-=p*b.x;h.y-=p*b.y;k-=r*(v*b.y-x*b.x);u.x+=l*b.x;u.y+=l*b.y;m+=s*(w*b.y-z*b.x);d.m_angularVelocity=k;g.m_angularVelocity=m};k.prototype.SolvePositionConstraints=function(){return!0};Box2D.inherit(l,Box2D.Dynamics.Joints.b2JointDef);l.prototype.__super=Box2D.Dynamics.Joints.b2JointDef.prototype;l.b2FrictionJointDef=function(){Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this,
arguments);this.localAnchorA=new e;this.localAnchorB=new e};l.prototype.b2FrictionJointDef=function(){this.__super.b2JointDef.call(this);this.type=v.e_frictionJoint;this.maxTorque=this.maxForce=0};l.prototype.Initialize=function(a,b,c){this.bodyA=a;this.bodyB=b;this.localAnchorA.SetV(this.bodyA.GetLocalPoint(c));this.localAnchorB.SetV(this.bodyB.GetLocalPoint(c))};Box2D.inherit(p,Box2D.Dynamics.Joints.b2Joint);p.prototype.__super=Box2D.Dynamics.Joints.b2Joint.prototype;p.b2GearJoint=function(){Box2D.Dynamics.Joints.b2Joint.b2Joint.apply(this,
arguments);this.m_groundAnchor1=new e;this.m_groundAnchor2=new e;this.m_localAnchor1=new e;this.m_localAnchor2=new e;this.m_J=new x};p.prototype.GetAnchorA=function(){return this.m_bodyA.GetWorldPoint(this.m_localAnchor1)};p.prototype.GetAnchorB=function(){return this.m_bodyB.GetWorldPoint(this.m_localAnchor2)};p.prototype.GetReactionForce=function(a){void 0===a&&(a=0);return new e(a*this.m_impulse*this.m_J.linearB.x,a*this.m_impulse*this.m_J.linearB.y)};p.prototype.GetReactionTorque=function(a){void 0===
a&&(a=0);var b=this.m_bodyB.m_xf.R,c=this.m_localAnchor1.x-this.m_bodyB.m_sweep.localCenter.x,f=this.m_localAnchor1.y-this.m_bodyB.m_sweep.localCenter.y,e=b.col1.x*c+b.col2.x*f,f=b.col1.y*c+b.col2.y*f;return a*(this.m_impulse*this.m_J.angularB-e*this.m_impulse*this.m_J.linearB.y+f*this.m_impulse*this.m_J.linearB.x)};p.prototype.GetRatio=function(){return this.m_ratio};p.prototype.SetRatio=function(a){void 0===a&&(a=0);this.m_ratio=a};p.prototype.b2GearJoint=function(a){this.__super.b2Joint.call(this,
...
null,this.m_groundAnchor2.SetV(this.m_prismatic2.m_localAnchor1),this.m_localAnchor2.SetV(this.m_prismatic2.m_localAnchor2),e=this.m_prismatic2.GetJointTranslation());this.m_ratio=a.ratio;this.m_constant=f+this.m_ratio*e;this.m_impulse=0};p.prototype.InitVelocityConstraints=function(a){var b=this.m_ground1,c=this.m_ground2,f=this.m_bodyA,e=this.m_bodyB,d=0,g=0,h=0,k=0,p=0,l=0;this.m_J.SetZero();this.m_revolute1?(this.m_J.angularA=-1,l+=f.m_invI):(b=b.m_xf.R,g=this.m_prismatic1.m_localXAxis1,d=b.col1.x*
g.x+b.col2.x*g.y,g=b.col1.y*g.x+b.col2.y*g.y,b=f.m_xf.R,h=this.m_localAnchor1.x-f.m_sweep.localCenter.x,k=this.m_localAnchor1.y-f.m_sweep.localCenter.y,p=b.col1.x*h+b.col2.x*k,k=b.col1.y*h+b.col2.y*k,h=p*g-k*d,this.m_J.linearA.Set(-d,-g),this.m_J.angularA=-h,l+=f.m_invMass+f.m_invI*h*h);this.m_revolute2?(this.m_J.angularB=-this.m_ratio,l+=this.m_ratio*this.m_ratio*e.m_invI):(b=c.m_xf.R,g=this.m_prismatic2.m_localXAxis1,d=b.col1.x*g.x+b.col2.x*g.y,g=b.col1.y*g.x+b.col2.y*g.y,b=e.m_xf.R,h=this.m_localAnchor2.x-
e.m_sweep.localCenter.x,k=this.m_localAnchor2.y-e.m_sweep.localCenter.y,p=b.col1.x*h+b.col2.x*k,k=b.col1.y*h+b.col2.y*k,h=p*g-k*d,this.m_J.linearB.Set(-this.m_ratio*d,-this.m_ratio*g),this.m_J.angularB=-this.m_ratio*h,l+=this.m_ratio*this.m_ratio*(e.m_invMass+e.m_invI*h*h));this.m_mass=0<l?1/l:0;a.warmStarting?(f.m_linearVelocity.x+=f.m_invMass*this.m_impulse*this.m_J.linearA.x,f.m_linearVelocity.y+=f.m_invMass*this.m_impulse*this.m_J.linearA.y,f.m_angularVelocity+=f.m_invI*this.m_impulse*this.m_J.angularA,
e.m_linearVelocity.x+=e.m_invMass*this.m_impulse*this.m_J.linearB.x,e.m_linearVelocity.y+=e.m_invMass*this.m_impulse*this.m_J.linearB.y,e.m_angularVelocity+=e.m_invI*this.m_impulse*this.m_J.angularB):this.m_impulse=0};p.prototype.SolveVelocityConstraints=function(){var a=this.m_bodyA,b=this.m_bodyB,c=-this.m_mass*this.m_J.Compute(a.m_linearVelocity,a.m_angularVelocity,b.m_linearVelocity,b.m_angularVelocity);this.m_impulse+=c;a.m_linearVelocity.x+=a.m_invMass*c*this.m_J.linearA.x;a.m_linearVelocity.y+=
a.m_invMass*c*this.m_J.linearA.y;a.m_angularVelocity+=a.m_invI*c*this.m_J.angularA;b.m_linearVelocity.x+=b.m_invMass*c*this.m_J.linearB.x;b.m_linearVelocity.y+=b.m_invMass*c*this.m_J.linearB.y;b.m_angularVelocity+=b.m_invI*c*this.m_J.angularB};p.prototype.SolvePositionConstraints=function(){var a=this.m_bodyA,c=this.m_bodyB,f=0,e=0,f=this.m_revolute1?this.m_revolute1.GetJointAngle():this.m_prismatic1.GetJointTranslation(),e=this.m_revolute2?this.m_revolute2.GetJointAngle():this.m_prismatic2.GetJointTranslation(),
...
new g(a instanceof h?a:null);break;case v.e_mouseJoint:b=new A(a instanceof z?a:null);break;case v.e_prismaticJoint:b=new D(a instanceof H?a:null);break;case v.e_revoluteJoint:b=new G(a instanceof I?a:null);break;case v.e_pulleyJoint:b=new C(a instanceof M?a:null);break;case v.e_gearJoint:b=new p(a instanceof s?a:null);break;case v.e_lineJoint:b=new r(a instanceof E?a:null);break;case v.e_weldJoint:b=new N(a instanceof L?a:null);break;case v.e_frictionJoint:b=new k(a instanceof l?a:null)}return b};
...
new e;this.m_localXAxis1=new e;this.m_localYAxis1=new e;this.m_axis=new e;this.m_perp=new e;this.m_K=new c;this.m_impulse=new e};r.prototype.GetAnchorA=function(){return this.m_bodyA.GetWorldPoint(this.m_localAnchor1)};r.prototype.GetAnchorB=function(){return this.m_bodyB.GetWorldPoint(this.m_localAnchor2)};r.prototype.GetReactionForce=function(a){void 0===a&&(a=0);return new e(a*(this.m_impulse.x*this.m_perp.x+(this.m_motorImpulse+this.m_impulse.y)*this.m_axis.x),a*(this.m_impulse.x*this.m_perp.y+
(this.m_motorImpulse+this.m_impulse.y)*this.m_axis.y))};r.prototype.GetReactionTorque=function(a){void 0===a&&(a=0);return a*this.m_impulse.y};r.prototype.GetJointTranslation=function(){var a=this.m_bodyA,b=this.m_bodyB,c=a.GetWorldPoint(this.m_localAnchor1),f=b.GetWorldPoint(this.m_localAnchor2),b=f.x-c.x,c=f.y-c.y,a=a.GetWorldVector(this.m_localXAxis1);return a.x*b+a.y*c};r.prototype.GetJointSpeed=function(){var a=this.m_bodyA,b=this.m_bodyB,c;c=a.m_xf.R;var f=this.m_localAnchor1.x-a.m_sweep.localCenter.x,
e=this.m_localAnchor1.y-a.m_sweep.localCenter.y,d=c.col1.x*f+c.col2.x*e,e=c.col1.y*f+c.col2.y*e,f=d;c=b.m_xf.R;var g=this.m_localAnchor2.x-b.m_sweep.localCenter.x,h=this.m_localAnchor2.y-b.m_sweep.localCenter.y,d=c.col1.x*g+c.col2.x*h,h=c.col1.y*g+c.col2.y*h,g=d;c=b.m_sweep.c.x+g-(a.m_sweep.c.x+f);var d=b.m_sweep.c.y+h-(a.m_sweep.c.y+e),k=a.GetWorldVector(this.m_localXAxis1),p=a.m_linearVelocity,l=b.m_linearVelocity,a=a.m_angularVelocity,b=b.m_angularVelocity;return c*-a*k.y+d*a*k.x+(k.x*(l.x+-b*
h-p.x- -a*e)+k.y*(l.y+b*g-p.y-a*f))};r.prototype.IsLimitEnabled=function(){return this.m_enableLimit};r.prototype.EnableLimit=function(a){this.m_bodyA.SetAwake(!0);this.m_bodyB.SetAwake(!0);this.m_enableLimit=a};r.prototype.GetLowerLimit=function(){return this.m_lowerTranslation};r.prototype.GetUpperLimit=function(){return this.m_upperTranslation};r.prototype.SetLimits=function(a,b){void 0===a&&(a=0);void 0===b&&(b=0);this.m_bodyA.SetAwake(!0);this.m_bodyB.SetAwake(!0);this.m_lowerTranslation=a;this.m_upperTranslation=
...
this.m_localCenterA.x,u=this.m_localAnchor1.y-this.m_localCenterA.y,g=d.col1.x*k+d.col2.x*u,u=d.col1.y*k+d.col2.y*u,k=g;d=e.m_xf.R;var m=this.m_localAnchor2.x-this.m_localCenterB.x,p=this.m_localAnchor2.y-this.m_localCenterB.y,g=d.col1.x*m+d.col2.x*p,p=d.col1.y*m+d.col2.y*p,m=g;d=e.m_sweep.c.x+m-c.m_sweep.c.x-k;g=e.m_sweep.c.y+p-c.m_sweep.c.y-u;this.m_invMassA=c.m_invMass;this.m_invMassB=e.m_invMass;this.m_invIA=c.m_invI;this.m_invIB=e.m_invI;this.m_axis.SetV(f.MulMV(h.R,this.m_localXAxis1));this.m_a1=
(d+k)*this.m_axis.y-(g+u)*this.m_axis.x;this.m_a2=m*this.m_axis.y-p*this.m_axis.x;this.m_motorMass=this.m_invMassA+this.m_invMassB+this.m_invIA*this.m_a1*this.m_a1+this.m_invIB*this.m_a2*this.m_a2;this.m_motorMass=this.m_motorMass>Number.MIN_VALUE?1/this.m_motorMass:0;this.m_perp.SetV(f.MulMV(h.R,this.m_localYAxis1));this.m_s1=(d+k)*this.m_perp.y-(g+u)*this.m_perp.x;this.m_s2=m*this.m_perp.y-p*this.m_perp.x;h=this.m_invMassA;k=this.m_invMassB;u=this.m_invIA;m=this.m_invIB;this.m_K.col1.x=h+k+u*this.m_s1*
this.m_s1+m*this.m_s2*this.m_s2;this.m_K.col1.y=u*this.m_s1*this.m_a1+m*this.m_s2*this.m_a2;this.m_K.col2.x=this.m_K.col1.y;this.m_K.col2.y=h+k+u*this.m_a1*this.m_a1+m*this.m_a2*this.m_a2;this.m_enableLimit?(d=this.m_axis.x*d+this.m_axis.y*g,f.Abs(this.m_upperTranslation-this.m_lowerTranslation)<2*b.b2_linearSlop?this.m_limitState=v.e_equalLimits:d<=this.m_lowerTranslation?this.m_limitState!=v.e_atLowerLimit&&(this.m_limitState=v.e_atLowerLimit,this.m_impulse.y=0):d>=this.m_upperTranslation?this.m_limitState!=
...
this.m_s1+(this.m_motorImpulse+this.m_impulse.y)*this.m_a1,h=this.m_impulse.x*this.m_s2+(this.m_motorImpulse+this.m_impulse.y)*this.m_a2,c.m_linearVelocity.x-=this.m_invMassA*a,c.m_linearVelocity.y-=this.m_invMassA*d,c.m_angularVelocity-=this.m_invIA*g,e.m_linearVelocity.x+=this.m_invMassB*a,e.m_linearVelocity.y+=this.m_invMassB*d,e.m_angularVelocity+=this.m_invIB*h):(this.m_impulse.SetZero(),this.m_motorImpulse=0)};r.prototype.SolveVelocityConstraints=function(a){var b=this.m_bodyA,c=this.m_bodyB,
d=b.m_linearVelocity,g=b.m_angularVelocity,h=c.m_linearVelocity,k=c.m_angularVelocity,u=0,m=0,p=0,l=0;this.m_enableMotor&&this.m_limitState!=v.e_equalLimits&&(l=this.m_motorMass*(this.m_motorSpeed-(this.m_axis.x*(h.x-d.x)+this.m_axis.y*(h.y-d.y)+this.m_a2*k-this.m_a1*g)),u=this.m_motorImpulse,m=a.dt*this.m_maxMotorForce,this.m_motorImpulse=f.Clamp(this.m_motorImpulse+l,-m,m),l=this.m_motorImpulse-u,u=l*this.m_axis.x,m=l*this.m_axis.y,p=l*this.m_a1,l*=this.m_a2,d.x-=this.m_invMassA*u,d.y-=this.m_invMassA*
m,g-=this.m_invIA*p,h.x+=this.m_invMassB*u,h.y+=this.m_invMassB*m,k+=this.m_invIB*l);m=this.m_perp.x*(h.x-d.x)+this.m_perp.y*(h.y-d.y)+this.m_s2*k-this.m_s1*g;this.m_enableLimit&&this.m_limitState!=v.e_inactiveLimit?(p=this.m_axis.x*(h.x-d.x)+this.m_axis.y*(h.y-d.y)+this.m_a2*k-this.m_a1*g,u=this.m_impulse.Copy(),a=this.m_K.Solve(new e,-m,-p),this.m_impulse.Add(a),this.m_limitState==v.e_atLowerLimit?this.m_impulse.y=f.Max(this.m_impulse.y,0):this.m_limitState==v.e_atUpperLimit&&(this.m_impulse.y=
f.Min(this.m_impulse.y,0)),m=-m-(this.m_impulse.y-u.y)*this.m_K.col2.x,p=0!=this.m_K.col1.x?m/this.m_K.col1.x+u.x:u.x,this.m_impulse.x=p,a.x=this.m_impulse.x-u.x,a.y=this.m_impulse.y-u.y,u=a.x*this.m_perp.x+a.y*this.m_axis.x,m=a.x*this.m_perp.y+a.y*this.m_axis.y,p=a.x*this.m_s1+a.y*this.m_a1,l=a.x*this.m_s2+a.y*this.m_a2):(a=0!=this.m_K.col1.x?-m/this.m_K.col1.x:0,this.m_impulse.x+=a,u=a*this.m_perp.x,m=a*this.m_perp.y,p=a*this.m_s1,l=a*this.m_s2);d.x-=this.m_invMassA*u;d.y-=this.m_invMassA*m;g-=
this.m_invIA*p;h.x+=this.m_invMassB*u;h.y+=this.m_invMassB*m;k+=this.m_invIB*l;b.m_linearVelocity.SetV(d);b.m_angularVelocity=g;c.m_linearVelocity.SetV(h);c.m_angularVelocity=k};r.prototype.SolvePositionConstraints=function(){var a=this.m_bodyA,d=this.m_bodyB,g=a.m_sweep.c,h=a.m_sweep.a,k=d.m_sweep.c,p=d.m_sweep.a,l,u=0,m=0,r=0,s=0,v=0,x=0,m=!1,w=0,z=c.FromAngle(h),r=c.FromAngle(p);l=z;var x=this.m_localAnchor1.x-this.m_localCenterA.x,A=this.m_localAnchor1.y-this.m_localCenterA.y,u=l.col1.x*x+l.col2.x*
A,A=l.col1.y*x+l.col2.y*A,x=u;l=r;r=this.m_localAnchor2.x-this.m_localCenterB.x;s=this.m_localAnchor2.y-this.m_localCenterB.y;u=l.col1.x*r+l.col2.x*s;s=l.col1.y*r+l.col2.y*s;r=u;l=k.x+r-g.x-x;u=k.y+s-g.y-A;if(this.m_enableLimit){this.m_axis=f.MulMV(z,this.m_localXAxis1);this.m_a1=(l+x)*this.m_axis.y-(u+A)*this.m_axis.x;this.m_a2=r*this.m_axis.y-s*this.m_axis.x;var C=this.m_axis.x*l+this.m_axis.y*u;f.Abs(this.m_upperTranslation-this.m_lowerTranslation)<2*b.b2_linearSlop?(w=f.Clamp(C,-b.b2_maxLinearCorrection,
b.b2_maxLinearCorrection),v=f.Abs(C),m=!0):C<=this.m_lowerTranslation?(w=f.Clamp(C-this.m_lowerTranslation+b.b2_linearSlop,-b.b2_maxLinearCorrection,0),v=this.m_lowerTranslation-C,m=!0):C>=this.m_upperTranslation&&(w=f.Clamp(C-this.m_upperTranslation+b.b2_linearSlop,0,b.b2_maxLinearCorrection),v=C-this.m_upperTranslation,m=!0)}this.m_perp=f.MulMV(z,this.m_localYAxis1);this.m_s1=(l+x)*this.m_perp.y-(u+A)*this.m_perp.x;this.m_s2=r*this.m_perp.y-s*this.m_perp.x;z=new e;A=this.m_perp.x*l+this.m_perp.y*
u;v=f.Max(v,f.Abs(A));x=0;m?(m=this.m_invMassA,r=this.m_invMassB,s=this.m_invIA,l=this.m_invIB,this.m_K.col1.x=m+r+s*this.m_s1*this.m_s1+l*this.m_s2*this.m_s2,this.m_K.col1.y=s*this.m_s1*this.m_a1+l*this.m_s2*this.m_a2,this.m_K.col2.x=this.m_K.col1.y,this.m_K.col2.y=m+r+s*this.m_a1*this.m_a1+l*this.m_a2*this.m_a2,this.m_K.Solve(z,-A,-w)):(m=this.m_invMassA,r=this.m_invMassB,s=this.m_invIA,l=this.m_invIB,w=m+r+s*this.m_s1*this.m_s1+l*this.m_s2*this.m_s2,z.x=0!=w?-A/w:0,z.y=0);w=z.x*this.m_perp.x+z.y*
this.m_axis.x;m=z.x*this.m_perp.y+z.y*this.m_axis.y;A=z.x*this.m_s1+z.y*this.m_a1;z=z.x*this.m_s2+z.y*this.m_a2;g.x-=this.m_invMassA*w;g.y-=this.m_invMassA*m;h-=this.m_invIA*A;k.x+=this.m_invMassB*w;k.y+=this.m_invMassB*m;p+=this.m_invIB*z;a.m_sweep.a=h;d.m_sweep.a=p;a.SynchronizeTransform();d.SynchronizeTransform();return v<=b.b2_linearSlop&&x<=b.b2_angularSlop};Box2D.inherit(E,Box2D.Dynamics.Joints.b2JointDef);E.prototype.__super=Box2D.Dynamics.Joints.b2JointDef.prototype;E.b2LineJointDef=function(){Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this,
...
f);var d=b.m_sweep.c.y+h-(a.m_sweep.c.y+e),k=a.GetWorldVector(this.m_localXAxis1),l=a.m_linearVelocity,p=b.m_linearVelocity,a=a.m_angularVelocity,b=b.m_angularVelocity;return c*-a*k.y+d*a*k.x+(k.x*(p.x+-b*h-l.x- -a*e)+k.y*(p.y+b*g-l.y-a*f))};D.prototype.IsLimitEnabled=function(){return this.m_enableLimit};D.prototype.EnableLimit=function(a){this.m_bodyA.SetAwake(!0);this.m_bodyB.SetAwake(!0);this.m_enableLimit=a};D.prototype.GetLowerLimit=function(){return this.m_lowerTranslation};D.prototype.GetUpperLimit=
...
e=this.m_bodyB,d,g=0;this.m_localCenterA.SetV(c.GetLocalCenter());this.m_localCenterB.SetV(e.GetLocalCenter());var h=c.GetTransform();e.GetTransform();d=c.m_xf.R;var k=this.m_localAnchor1.x-this.m_localCenterA.x,u=this.m_localAnchor1.y-this.m_localCenterA.y,g=d.col1.x*k+d.col2.x*u,u=d.col1.y*k+d.col2.y*u,k=g;d=e.m_xf.R;var m=this.m_localAnchor2.x-this.m_localCenterB.x,l=this.m_localAnchor2.y-this.m_localCenterB.y,g=d.col1.x*m+d.col2.x*l,l=d.col1.y*m+d.col2.y*l,m=g;d=e.m_sweep.c.x+m-c.m_sweep.c.x-
k;g=e.m_sweep.c.y+l-c.m_sweep.c.y-u;this.m_invMassA=c.m_invMass;this.m_invMassB=e.m_invMass;this.m_invIA=c.m_invI;this.m_invIB=e.m_invI;this.m_axis.SetV(f.MulMV(h.R,this.m_localXAxis1));this.m_a1=(d+k)*this.m_axis.y-(g+u)*this.m_axis.x;this.m_a2=m*this.m_axis.y-l*this.m_axis.x;this.m_motorMass=this.m_invMassA+this.m_invMassB+this.m_invIA*this.m_a1*this.m_a1+this.m_invIB*this.m_a2*this.m_a2;this.m_motorMass>Number.MIN_VALUE&&(this.m_motorMass=1/this.m_motorMass);this.m_perp.SetV(f.MulMV(h.R,this.m_localYAxis1));
this.m_s1=(d+k)*this.m_perp.y-(g+u)*this.m_perp.x;this.m_s2=m*this.m_perp.y-l*this.m_perp.x;h=this.m_invMassA;k=this.m_invMassB;u=this.m_invIA;m=this.m_invIB;this.m_K.col1.x=h+k+u*this.m_s1*this.m_s1+m*this.m_s2*this.m_s2;this.m_K.col1.y=u*this.m_s1+m*this.m_s2;this.m_K.col1.z=u*this.m_s1*this.m_a1+m*this.m_s2*this.m_a2;this.m_K.col2.x=this.m_K.col1.y;this.m_K.col2.y=u+m;this.m_K.col2.z=u*this.m_a1+m*this.m_a2;this.m_K.col3.x=this.m_K.col1.z;this.m_K.col3.y=this.m_K.col2.z;this.m_K.col3.z=h+k+u*this.m_a1*
this.m_a1+m*this.m_a2*this.m_a2;this.m_enableLimit?(d=this.m_axis.x*d+this.m_axis.y*g,f.Abs(this.m_upperTranslation-this.m_lowerTranslation)<2*b.b2_linearSlop?this.m_limitState=v.e_equalLimits:d<=this.m_lowerTranslation?this.m_limitState!=v.e_atLowerLimit&&(this.m_limitState=v.e_atLowerLimit,this.m_impulse.z=0):d>=this.m_upperTranslation?this.m_limitState!=v.e_atUpperLimit&&(this.m_limitState=v.e_atUpperLimit,this.m_impulse.z=0):(this.m_limitState=v.e_inactiveLimit,this.m_impulse.z=0)):this.m_limitState=
...
this.m_impulse.z)*this.m_a2,c.m_linearVelocity.x-=this.m_invMassA*a,c.m_linearVelocity.y-=this.m_invMassA*d,c.m_angularVelocity-=this.m_invIA*g,e.m_linearVelocity.x+=this.m_invMassB*a,e.m_linearVelocity.y+=this.m_invMassB*d,e.m_angularVelocity+=this.m_invIB*h):(this.m_impulse.SetZero(),this.m_motorImpulse=0)};D.prototype.SolveVelocityConstraints=function(a){var b=this.m_bodyA,c=this.m_bodyB,g=b.m_linearVelocity,h=b.m_angularVelocity,k=c.m_linearVelocity,l=c.m_angularVelocity,u=0,m=0,p=0,r=0;this.m_enableMotor&&
this.m_limitState!=v.e_equalLimits&&(r=this.m_motorMass*(this.m_motorSpeed-(this.m_axis.x*(k.x-g.x)+this.m_axis.y*(k.y-g.y)+this.m_a2*l-this.m_a1*h)),u=this.m_motorImpulse,a=a.dt*this.m_maxMotorForce,this.m_motorImpulse=f.Clamp(this.m_motorImpulse+r,-a,a),r=this.m_motorImpulse-u,u=r*this.m_axis.x,m=r*this.m_axis.y,p=r*this.m_a1,r*=this.m_a2,g.x-=this.m_invMassA*u,g.y-=this.m_invMassA*m,h-=this.m_invIA*p,k.x+=this.m_invMassB*u,k.y+=this.m_invMassB*m,l+=this.m_invIB*r);p=this.m_perp.x*(k.x-g.x)+this.m_perp.y*
(k.y-g.y)+this.m_s2*l-this.m_s1*h;m=l-h;this.m_enableLimit&&this.m_limitState!=v.e_inactiveLimit?(a=this.m_axis.x*(k.x-g.x)+this.m_axis.y*(k.y-g.y)+this.m_a2*l-this.m_a1*h,u=this.m_impulse.Copy(),a=this.m_K.Solve33(new d,-p,-m,-a),this.m_impulse.Add(a),this.m_limitState==v.e_atLowerLimit?this.m_impulse.z=f.Max(this.m_impulse.z,0):this.m_limitState==v.e_atUpperLimit&&(this.m_impulse.z=f.Min(this.m_impulse.z,0)),p=-p-(this.m_impulse.z-u.z)*this.m_K.col3.x,m=-m-(this.m_impulse.z-u.z)*this.m_K.col3.y,
m=this.m_K.Solve22(new e,p,m),m.x+=u.x,m.y+=u.y,this.m_impulse.x=m.x,this.m_impulse.y=m.y,a.x=this.m_impulse.x-u.x,a.y=this.m_impulse.y-u.y,a.z=this.m_impulse.z-u.z,u=a.x*this.m_perp.x+a.z*this.m_axis.x,m=a.x*this.m_perp.y+a.z*this.m_axis.y,p=a.x*this.m_s1+a.y+a.z*this.m_a1,r=a.x*this.m_s2+a.y+a.z*this.m_a2):(a=this.m_K.Solve22(new e,-p,-m),this.m_impulse.x+=a.x,this.m_impulse.y+=a.y,u=a.x*this.m_perp.x,m=a.x*this.m_perp.y,p=a.x*this.m_s1+a.y,r=a.x*this.m_s2+a.y);g.x-=this.m_invMassA*u;g.y-=this.m_invMassA*
m;h-=this.m_invIA*p;k.x+=this.m_invMassB*u;k.y+=this.m_invMassB*m;l+=this.m_invIB*r;b.m_linearVelocity.SetV(g);b.m_angularVelocity=h;c.m_linearVelocity.SetV(k);c.m_angularVelocity=l};D.prototype.SolvePositionConstraints=function(){var a=this.m_bodyA,g=this.m_bodyB,h=a.m_sweep.c,k=a.m_sweep.a,l=g.m_sweep.c,p=g.m_sweep.a,r,u=0,m=0,s=0,v=0,x=0,m=!1,w=0,z=c.FromAngle(k),A=c.FromAngle(p);r=z;var x=this.m_localAnchor1.x-this.m_localCenterA.x,C=this.m_localAnchor1.y-this.m_localCenterA.y,u=r.col1.x*x+r.col2.x*
...
b.b2_maxLinearCorrection),v=f.Abs(D),m=!0):D<=this.m_lowerTranslation?(w=f.Clamp(D-this.m_lowerTranslation+b.b2_linearSlop,-b.b2_maxLinearCorrection,0),v=this.m_lowerTranslation-D,m=!0):D>=this.m_upperTranslation&&(w=f.Clamp(D-this.m_upperTranslation+b.b2_linearSlop,0,b.b2_maxLinearCorrection),v=D-this.m_upperTranslation,m=!0)}this.m_perp=f.MulMV(z,this.m_localYAxis1);this.m_s1=(r+x)*this.m_perp.y-(u+C)*this.m_perp.x;this.m_s2=A*this.m_perp.y-s*this.m_perp.x;z=new d;C=this.m_perp.x*r+this.m_perp.y*
u;A=p-k-this.m_refAngle;v=f.Max(v,f.Abs(C));x=f.Abs(A);m?(m=this.m_invMassA,s=this.m_invMassB,r=this.m_invIA,u=this.m_invIB,this.m_K.col1.x=m+s+r*this.m_s1*this.m_s1+u*this.m_s2*this.m_s2,this.m_K.col1.y=r*this.m_s1+u*this.m_s2,this.m_K.col1.z=r*this.m_s1*this.m_a1+u*this.m_s2*this.m_a2,this.m_K.col2.x=this.m_K.col1.y,this.m_K.col2.y=r+u,this.m_K.col2.z=r*this.m_a1+u*this.m_a2,this.m_K.col3.x=this.m_K.col1.z,this.m_K.col3.y=this.m_K.col2.z,this.m_K.col3.z=m+s+r*this.m_a1*this.m_a1+u*this.m_a2*this.m_a2,
this.m_K.Solve33(z,-C,-A,-w)):(m=this.m_invMassA,s=this.m_invMassB,r=this.m_invIA,u=this.m_invIB,w=r*this.m_s1+u*this.m_s2,D=r+u,this.m_K.col1.Set(m+s+r*this.m_s1*this.m_s1+u*this.m_s2*this.m_s2,w,0),this.m_K.col2.Set(w,D,0),w=this.m_K.Solve22(new e,-C,-A),z.x=w.x,z.y=w.y,z.z=0);w=z.x*this.m_perp.x+z.z*this.m_axis.x;m=z.x*this.m_perp.y+z.z*this.m_axis.y;C=z.x*this.m_s1+z.y+z.z*this.m_a1;z=z.x*this.m_s2+z.y+z.z*this.m_a2;h.x-=this.m_invMassA*w;h.y-=this.m_invMassA*m;k-=this.m_invIA*C;l.x+=this.m_invMassB*
w;l.y+=this.m_invMassB*m;p+=this.m_invIB*z;a.m_sweep.a=k;g.m_sweep.a=p;a.SynchronizeTransform();g.SynchronizeTransform();return v<=b.b2_linearSlop&&x<=b.b2_angularSlop};Box2D.inherit(H,Box2D.Dynamics.Joints.b2JointDef);H.prototype.__super=Box2D.Dynamics.Joints.b2JointDef.prototype;H.b2PrismaticJointDef=function(){Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this,arguments);this.localAnchorA=new e;this.localAnchorB=new e;this.localAxisA=new e};H.prototype.b2PrismaticJointDef=function(){this.__super.b2JointDef.call(this);
...
this.m_impulse-this.m_limitImpulse2)*this.m_u2.y,c.m_linearVelocity.x+=c.m_invMass*a,c.m_linearVelocity.y+=c.m_invMass*e,c.m_angularVelocity+=c.m_invI*(d*e-g*a),f.m_linearVelocity.x+=f.m_invMass*h,f.m_linearVelocity.y+=f.m_invMass*l,f.m_angularVelocity+=f.m_invI*(k*l-m*h)):this.m_limitImpulse2=this.m_limitImpulse1=this.m_impulse=0};C.prototype.SolveVelocityConstraints=function(){var a=this.m_bodyA,b=this.m_bodyB,c;c=a.m_xf.R;var e=this.m_localAnchor1.x-a.m_sweep.localCenter.x,d=this.m_localAnchor1.y-
a.m_sweep.localCenter.y,g=c.col1.x*e+c.col2.x*d,d=c.col1.y*e+c.col2.y*d,e=g;c=b.m_xf.R;var h=this.m_localAnchor2.x-b.m_sweep.localCenter.x,k=this.m_localAnchor2.y-b.m_sweep.localCenter.y,g=c.col1.x*h+c.col2.x*k,k=c.col1.y*h+c.col2.y*k,h=g,m=0,l=0;this.m_state==v.e_atUpperLimit&&(c=a.m_linearVelocity.x+-a.m_angularVelocity*d,g=a.m_linearVelocity.y+a.m_angularVelocity*e,m=b.m_linearVelocity.x+-b.m_angularVelocity*k,l=b.m_linearVelocity.y+b.m_angularVelocity*h,c=-(this.m_u1.x*c+this.m_u1.y*g)-this.m_ratio*
(this.m_u2.x*m+this.m_u2.y*l),l=this.m_pulleyMass*-c,c=this.m_impulse,this.m_impulse=f.Max(0,this.m_impulse+l),l=this.m_impulse-c,c=-l*this.m_u1.x,g=-l*this.m_u1.y,m=-this.m_ratio*l*this.m_u2.x,l=-this.m_ratio*l*this.m_u2.y,a.m_linearVelocity.x+=a.m_invMass*c,a.m_linearVelocity.y+=a.m_invMass*g,a.m_angularVelocity+=a.m_invI*(e*g-d*c),b.m_linearVelocity.x+=b.m_invMass*m,b.m_linearVelocity.y+=b.m_invMass*l,b.m_angularVelocity+=b.m_invI*(h*l-k*m));this.m_limitState1==v.e_atUpperLimit&&(c=a.m_linearVelocity.x+
-a.m_angularVelocity*d,g=a.m_linearVelocity.y+a.m_angularVelocity*e,c=-(this.m_u1.x*c+this.m_u1.y*g),l=-this.m_limitMass1*c,c=this.m_limitImpulse1,this.m_limitImpulse1=f.Max(0,this.m_limitImpulse1+l),l=this.m_limitImpulse1-c,c=-l*this.m_u1.x,g=-l*this.m_u1.y,a.m_linearVelocity.x+=a.m_invMass*c,a.m_linearVelocity.y+=a.m_invMass*g,a.m_angularVelocity+=a.m_invI*(e*g-d*c));this.m_limitState2==v.e_atUpperLimit&&(m=b.m_linearVelocity.x+-b.m_angularVelocity*k,l=b.m_linearVelocity.y+b.m_angularVelocity*h,
c=-(this.m_u2.x*m+this.m_u2.y*l),l=-this.m_limitMass2*c,c=this.m_limitImpulse2,this.m_limitImpulse2=f.Max(0,this.m_limitImpulse2+l),l=this.m_limitImpulse2-c,m=-l*this.m_u2.x,l=-l*this.m_u2.y,b.m_linearVelocity.x+=b.m_invMass*m,b.m_linearVelocity.y+=b.m_invMass*l,b.m_angularVelocity+=b.m_invI*(h*l-k*m))};C.prototype.SolvePositionConstraints=function(){var a=this.m_bodyA,c=this.m_bodyB,e,d=this.m_ground.m_xf.position.x+this.m_groundAnchor1.x,g=this.m_ground.m_xf.position.y+this.m_groundAnchor1.y,h=
this.m_ground.m_xf.position.x+this.m_groundAnchor2.x,k=this.m_ground.m_xf.position.y+this.m_groundAnchor2.y,l=0,m=0,p=0,r=0,s=0,x=0,w=0,z=0;this.m_state==v.e_atUpperLimit&&(e=a.m_xf.R,l=this.m_localAnchor1.x-a.m_sweep.localCenter.x,m=this.m_localAnchor1.y-a.m_sweep.localCenter.y,s=e.col1.x*l+e.col2.x*m,m=e.col1.y*l+e.col2.y*m,l=s,e=c.m_xf.R,p=this.m_localAnchor2.x-c.m_sweep.localCenter.x,r=this.m_localAnchor2.y-c.m_sweep.localCenter.y,s=e.col1.x*p+e.col2.x*r,r=e.col1.y*p+e.col2.y*r,p=s,e=a.m_sweep.c.x+
l,s=a.m_sweep.c.y+m,x=c.m_sweep.c.x+p,w=c.m_sweep.c.y+r,this.m_u1.Set(e-d,s-g),this.m_u2.Set(x-h,w-k),e=this.m_u1.Length(),s=this.m_u2.Length(),e>b.b2_linearSlop?this.m_u1.Multiply(1/e):this.m_u1.SetZero(),s>b.b2_linearSlop?this.m_u2.Multiply(1/s):this.m_u2.SetZero(),e=this.m_constant-e-this.m_ratio*s,z=f.Max(z,-e),e=f.Clamp(e+b.b2_linearSlop,-b.b2_maxLinearCorrection,0),w=-this.m_pulleyMass*e,e=-w*this.m_u1.x,s=-w*this.m_u1.y,x=-this.m_ratio*w*this.m_u2.x,w=-this.m_ratio*w*this.m_u2.y,a.m_sweep.c.x+=
a.m_invMass*e,a.m_sweep.c.y+=a.m_invMass*s,a.m_sweep.a+=a.m_invI*(l*s-m*e),c.m_sweep.c.x+=c.m_invMass*x,c.m_sweep.c.y+=c.m_invMass*w,c.m_sweep.a+=c.m_invI*(p*w-r*x),a.SynchronizeTransform(),c.SynchronizeTransform());this.m_limitState1==v.e_atUpperLimit&&(e=a.m_xf.R,l=this.m_localAnchor1.x-a.m_sweep.localCenter.x,m=this.m_localAnchor1.y-a.m_sweep.localCenter.y,s=e.col1.x*l+e.col2.x*m,m=e.col1.y*l+e.col2.y*m,l=s,e=a.m_sweep.c.x+l,s=a.m_sweep.c.y+m,this.m_u1.Set(e-d,s-g),e=this.m_u1.Length(),e>b.b2_linearSlop?
(this.m_u1.x*=1/e,this.m_u1.y*=1/e):this.m_u1.SetZero(),e=this.m_maxLength1-e,z=f.Max(z,-e),e=f.Clamp(e+b.b2_linearSlop,-b.b2_maxLinearCorrection,0),w=-this.m_limitMass1*e,e=-w*this.m_u1.x,s=-w*this.m_u1.y,a.m_sweep.c.x+=a.m_invMass*e,a.m_sweep.c.y+=a.m_invMass*s,a.m_sweep.a+=a.m_invI*(l*s-m*e),a.SynchronizeTransform());this.m_limitState2==v.e_atUpperLimit&&(e=c.m_xf.R,p=this.m_localAnchor2.x-c.m_sweep.localCenter.x,r=this.m_localAnchor2.y-c.m_sweep.localCenter.y,s=e.col1.x*p+e.col2.x*r,r=e.col1.y*
p+e.col2.y*r,p=s,x=c.m_sweep.c.x+p,w=c.m_sweep.c.y+r,this.m_u2.Set(x-h,w-k),s=this.m_u2.Length(),s>b.b2_linearSlop?(this.m_u2.x*=1/s,this.m_u2.y*=1/s):this.m_u2.SetZero(),e=this.m_maxLength2-s,z=f.Max(z,-e),e=f.Clamp(e+b.b2_linearSlop,-b.b2_maxLinearCorrection,0),w=-this.m_limitMass2*e,x=-w*this.m_u2.x,w=-w*this.m_u2.y,c.m_sweep.c.x+=c.m_invMass*x,c.m_sweep.c.y+=c.m_invMass*w,c.m_sweep.a+=c.m_invI*(p*w-r*x),c.SynchronizeTransform());return z<b.b2_linearSlop};Box2D.postDefs.push(function(){Box2D.Dynamics.Joints.b2PulleyJoint.b2_minPulleyLength=
...
k=this.m_localAnchor1.y-c.m_sweep.localCenter.y,g=d.col1.x*h+d.col2.x*k,k=d.col1.y*h+d.col2.y*k,h=g;d=e.m_xf.R;var l=this.m_localAnchor2.x-e.m_sweep.localCenter.x,m=this.m_localAnchor2.y-e.m_sweep.localCenter.y,g=d.col1.x*l+d.col2.x*m,m=d.col1.y*l+d.col2.y*m,l=g;d=c.m_invMass;var g=e.m_invMass,p=c.m_invI,r=e.m_invI;this.m_mass.col1.x=d+g+k*k*p+m*m*r;this.m_mass.col2.x=-k*h*p-m*l*r;this.m_mass.col3.x=-k*p-m*r;this.m_mass.col1.y=this.m_mass.col2.x;this.m_mass.col2.y=d+g+h*h*p+l*l*r;this.m_mass.col3.y=
h*p+l*r;this.m_mass.col1.z=this.m_mass.col3.x;this.m_mass.col2.z=this.m_mass.col3.y;this.m_mass.col3.z=p+r;this.m_motorMass=1/(p+r);!1==this.m_enableMotor&&(this.m_motorImpulse=0);if(this.m_enableLimit){var s=e.m_sweep.a-c.m_sweep.a-this.m_referenceAngle;f.Abs(this.m_upperAngle-this.m_lowerAngle)<2*b.b2_angularSlop?this.m_limitState=v.e_equalLimits:s<=this.m_lowerAngle?(this.m_limitState!=v.e_atLowerLimit&&(this.m_impulse.z=0),this.m_limitState=v.e_atLowerLimit):s>=this.m_upperAngle?(this.m_limitState!=
v.e_atUpperLimit&&(this.m_impulse.z=0),this.m_limitState=v.e_atUpperLimit):(this.m_limitState=v.e_inactiveLimit,this.m_impulse.z=0)}else this.m_limitState=v.e_inactiveLimit;a.warmStarting?(this.m_impulse.x*=a.dtRatio,this.m_impulse.y*=a.dtRatio,this.m_motorImpulse*=a.dtRatio,a=this.m_impulse.x,s=this.m_impulse.y,c.m_linearVelocity.x-=d*a,c.m_linearVelocity.y-=d*s,c.m_angularVelocity-=p*(h*s-k*a+this.m_motorImpulse+this.m_impulse.z),e.m_linearVelocity.x+=g*a,e.m_linearVelocity.y+=g*s,e.m_angularVelocity+=
r*(l*s-m*a+this.m_motorImpulse+this.m_impulse.z)):(this.m_impulse.SetZero(),this.m_motorImpulse=0)};G.prototype.SolveVelocityConstraints=function(a){var b=this.m_bodyA,c=this.m_bodyB,e=0,d=0,g=0,h=0,k=0,m=b.m_linearVelocity,l=b.m_angularVelocity,p=c.m_linearVelocity,r=c.m_angularVelocity,s=b.m_invMass,x=c.m_invMass,w=b.m_invI,z=c.m_invI;this.m_enableMotor&&this.m_limitState!=v.e_equalLimits&&(d=this.m_motorMass*-(r-l-this.m_motorSpeed),g=this.m_motorImpulse,h=a.dt*this.m_maxMotorTorque,this.m_motorImpulse=
f.Clamp(this.m_motorImpulse+d,-h,h),d=this.m_motorImpulse-g,l-=w*d,r+=z*d);if(this.m_enableLimit&&this.m_limitState!=v.e_inactiveLimit){a=b.m_xf.R;d=this.m_localAnchor1.x-b.m_sweep.localCenter.x;g=this.m_localAnchor1.y-b.m_sweep.localCenter.y;e=a.col1.x*d+a.col2.x*g;g=a.col1.y*d+a.col2.y*g;d=e;a=c.m_xf.R;h=this.m_localAnchor2.x-c.m_sweep.localCenter.x;k=this.m_localAnchor2.y-c.m_sweep.localCenter.y;e=a.col1.x*h+a.col2.x*k;k=a.col1.y*h+a.col2.y*k;h=e;a=p.x+-r*k-m.x- -l*g;var A=p.y+r*h-m.y-l*d;this.m_mass.Solve33(this.impulse3,
...
this.impulse3.x=this.reduced.x,this.impulse3.y=this.reduced.y,this.impulse3.z=-this.m_impulse.z,this.m_impulse.x+=this.reduced.x,this.m_impulse.y+=this.reduced.y,this.m_impulse.z=0));m.x-=s*this.impulse3.x;m.y-=s*this.impulse3.y;l-=w*(d*this.impulse3.y-g*this.impulse3.x+this.impulse3.z);p.x+=x*this.impulse3.x;p.y+=x*this.impulse3.y;r+=z*(h*this.impulse3.y-k*this.impulse3.x+this.impulse3.z)}else a=b.m_xf.R,d=this.m_localAnchor1.x-b.m_sweep.localCenter.x,g=this.m_localAnchor1.y-b.m_sweep.localCenter.y,
e=a.col1.x*d+a.col2.x*g,g=a.col1.y*d+a.col2.y*g,d=e,a=c.m_xf.R,h=this.m_localAnchor2.x-c.m_sweep.localCenter.x,k=this.m_localAnchor2.y-c.m_sweep.localCenter.y,e=a.col1.x*h+a.col2.x*k,k=a.col1.y*h+a.col2.y*k,h=e,this.m_mass.Solve22(this.impulse2,-(p.x+-r*k-m.x- -l*g),-(p.y+r*h-m.y-l*d)),this.m_impulse.x+=this.impulse2.x,this.m_impulse.y+=this.impulse2.y,m.x-=s*this.impulse2.x,m.y-=s*this.impulse2.y,l-=w*(d*this.impulse2.y-g*this.impulse2.x),p.x+=x*this.impulse2.x,p.y+=x*this.impulse2.y,r+=z*(h*this.impulse2.y-
k*this.impulse2.x);b.m_linearVelocity.SetV(m);b.m_angularVelocity=l;c.m_linearVelocity.SetV(p);c.m_angularVelocity=r};G.prototype.SolvePositionConstraints=function(){var a=0,c,e=this.m_bodyA,d=this.m_bodyB,g=0,h=0,k=0,l=0;if(this.m_enableLimit&&this.m_limitState!=v.e_inactiveLimit){var a=d.m_sweep.a-e.m_sweep.a-this.m_referenceAngle,m=0;this.m_limitState==v.e_equalLimits?(a=f.Clamp(a-this.m_lowerAngle,-b.b2_maxAngularCorrection,b.b2_maxAngularCorrection),m=-this.m_motorMass*a,g=f.Abs(a)):this.m_limitState==
v.e_atLowerLimit?(a-=this.m_lowerAngle,g=-a,a=f.Clamp(a+b.b2_angularSlop,-b.b2_maxAngularCorrection,0),m=-this.m_motorMass*a):this.m_limitState==v.e_atUpperLimit&&(g=a-=this.m_upperAngle,a=f.Clamp(a-b.b2_angularSlop,0,b.b2_maxAngularCorrection),m=-this.m_motorMass*a);e.m_sweep.a-=e.m_invI*m;d.m_sweep.a+=d.m_invI*m;e.SynchronizeTransform();d.SynchronizeTransform()}c=e.m_xf.R;m=this.m_localAnchor1.x-e.m_sweep.localCenter.x;a=this.m_localAnchor1.y-e.m_sweep.localCenter.y;h=c.col1.x*m+c.col2.x*a;a=c.col1.y*
m+c.col2.y*a;m=h;c=d.m_xf.R;var p=this.m_localAnchor2.x-d.m_sweep.localCenter.x,r=this.m_localAnchor2.y-d.m_sweep.localCenter.y,h=c.col1.x*p+c.col2.x*r,r=c.col1.y*p+c.col2.y*r,p=h,k=d.m_sweep.c.x+p-e.m_sweep.c.x-m,l=d.m_sweep.c.y+r-e.m_sweep.c.y-a,s=k*k+l*l;c=Math.sqrt(s);var h=e.m_invMass,x=d.m_invMass,w=e.m_invI,z=d.m_invI,A=10*b.b2_linearSlop;s>A*A&&(s=1/(h+x),k=s*-k,l=s*-l,e.m_sweep.c.x-=0.5*h*k,e.m_sweep.c.y-=0.5*h*l,d.m_sweep.c.x+=0.5*x*k,d.m_sweep.c.y+=0.5*x*l,k=d.m_sweep.c.x+p-e.m_sweep.c.x-
m,l=d.m_sweep.c.y+r-e.m_sweep.c.y-a);this.K1.col1.x=h+x;this.K1.col2.x=0;this.K1.col1.y=0;this.K1.col2.y=h+x;this.K2.col1.x=w*a*a;this.K2.col2.x=-w*m*a;this.K2.col1.y=-w*m*a;this.K2.col2.y=w*m*m;this.K3.col1.x=z*r*r;this.K3.col2.x=-z*p*r;this.K3.col1.y=-z*p*r;this.K3.col2.y=z*p*p;this.K.SetM(this.K1);this.K.AddM(this.K2);this.K.AddM(this.K3);this.K.Solve(G.tImpulse,-k,-l);k=G.tImpulse.x;l=G.tImpulse.y;e.m_sweep.c.x-=e.m_invMass*k;e.m_sweep.c.y-=e.m_invMass*l;e.m_sweep.a-=e.m_invI*(m*l-a*k);d.m_sweep.c.x+=
d.m_invMass*k;d.m_sweep.c.y+=d.m_invMass*l;d.m_sweep.a+=d.m_invI*(p*l-r*k);e.SynchronizeTransform();d.SynchronizeTransform();return c<=b.b2_linearSlop&&g<=b.b2_angularSlop};Box2D.postDefs.push(function(){Box2D.Dynamics.Joints.b2RevoluteJoint.tImpulse=new e});Box2D.inherit(I,Box2D.Dynamics.Joints.b2JointDef);I.prototype.__super=Box2D.Dynamics.Joints.b2JointDef.prototype;I.b2RevoluteJointDef=function(){Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this,arguments);this.localAnchorA=new e;this.localAnchorB=
...
f.m_sweep.localCenter.x,g=this.m_localAnchorA.y-f.m_sweep.localCenter.y,c=b.col1.x*d+b.col2.x*g,g=b.col1.y*d+b.col2.y*g,d=c;b=e.m_xf.R;var h=this.m_localAnchorB.x-e.m_sweep.localCenter.x,k=this.m_localAnchorB.y-e.m_sweep.localCenter.y,c=b.col1.x*h+b.col2.x*k,k=b.col1.y*h+b.col2.y*k,h=c;b=f.m_invMass;var c=e.m_invMass,l=f.m_invI,p=e.m_invI;this.m_mass.col1.x=b+c+g*g*l+k*k*p;this.m_mass.col2.x=-g*d*l-k*h*p;this.m_mass.col3.x=-g*l-k*p;this.m_mass.col1.y=this.m_mass.col2.x;this.m_mass.col2.y=b+c+d*d*
l+h*h*p;this.m_mass.col3.y=d*l+h*p;this.m_mass.col1.z=this.m_mass.col3.x;this.m_mass.col2.z=this.m_mass.col3.y;this.m_mass.col3.z=l+p;a.warmStarting?(this.m_impulse.x*=a.dtRatio,this.m_impulse.y*=a.dtRatio,this.m_impulse.z*=a.dtRatio,f.m_linearVelocity.x-=b*this.m_impulse.x,f.m_linearVelocity.y-=b*this.m_impulse.y,f.m_angularVelocity-=l*(d*this.m_impulse.y-g*this.m_impulse.x+this.m_impulse.z),e.m_linearVelocity.x+=c*this.m_impulse.x,e.m_linearVelocity.y+=c*this.m_impulse.y,e.m_angularVelocity+=p*
(h*this.m_impulse.y-k*this.m_impulse.x+this.m_impulse.z)):this.m_impulse.SetZero()};N.prototype.SolveVelocityConstraints=function(){var a,b=0,c=this.m_bodyA,f=this.m_bodyB,e=c.m_linearVelocity,g=c.m_angularVelocity,h=f.m_linearVelocity,k=f.m_angularVelocity,m=c.m_invMass,l=f.m_invMass,p=c.m_invI,r=f.m_invI;a=c.m_xf.R;var s=this.m_localAnchorA.x-c.m_sweep.localCenter.x,v=this.m_localAnchorA.y-c.m_sweep.localCenter.y,b=a.col1.x*s+a.col2.x*v,v=a.col1.y*s+a.col2.y*v,s=b;a=f.m_xf.R;var x=this.m_localAnchorB.x-
f.m_sweep.localCenter.x,w=this.m_localAnchorB.y-f.m_sweep.localCenter.y,b=a.col1.x*x+a.col2.x*w,w=a.col1.y*x+a.col2.y*w,x=b;a=h.x-k*w-e.x+g*v;var b=h.y+k*x-e.y-g*s,z=k-g,A=new d;this.m_mass.Solve33(A,-a,-b,-z);this.m_impulse.Add(A);e.x-=m*A.x;e.y-=m*A.y;g-=p*(s*A.y-v*A.x+A.z);h.x+=l*A.x;h.y+=l*A.y;k+=r*(x*A.y-w*A.x+A.z);c.m_angularVelocity=g;f.m_angularVelocity=k};N.prototype.SolvePositionConstraints=function(){var a,c=0,e=this.m_bodyA,g=this.m_bodyB;a=e.m_xf.R;var h=this.m_localAnchorA.x-e.m_sweep.localCenter.x,
k=this.m_localAnchorA.y-e.m_sweep.localCenter.y,c=a.col1.x*h+a.col2.x*k,k=a.col1.y*h+a.col2.y*k,h=c;a=g.m_xf.R;var l=this.m_localAnchorB.x-g.m_sweep.localCenter.x,p=this.m_localAnchorB.y-g.m_sweep.localCenter.y,c=a.col1.x*l+a.col2.x*p,p=a.col1.y*l+a.col2.y*p,l=c;a=e.m_invMass;var c=g.m_invMass,m=e.m_invI,r=g.m_invI,s=g.m_sweep.c.x+l-e.m_sweep.c.x-h,v=g.m_sweep.c.y+p-e.m_sweep.c.y-k,x=g.m_sweep.a-e.m_sweep.a-this.m_referenceAngle,w=10*b.b2_linearSlop,z=Math.sqrt(s*s+v*v),A=f.Abs(x);z>w&&(m*=1,r*=1);
this.m_mass.col1.x=a+c+k*k*m+p*p*r;this.m_mass.col2.x=-k*h*m-p*l*r;this.m_mass.col3.x=-k*m-p*r;this.m_mass.col1.y=this.m_mass.col2.x;this.m_mass.col2.y=a+c+h*h*m+l*l*r;this.m_mass.col3.y=h*m+l*r;this.m_mass.col1.z=this.m_mass.col3.x;this.m_mass.col2.z=this.m_mass.col3.y;this.m_mass.col3.z=m+r;w=new d;this.m_mass.Solve33(w,-s,-v,-x);e.m_sweep.c.x-=a*w.x;e.m_sweep.c.y-=a*w.y;e.m_sweep.a-=m*(h*w.y-k*w.x+w.z);g.m_sweep.c.x+=c*w.x;g.m_sweep.c.y+=c*w.y;g.m_sweep.a+=r*(l*w.y-p*w.x+w.z);e.SynchronizeTransform();
...
(function(b,c,a){function f(a){return"[object Function]"==w.call(a)}function e(a){return"string"==typeof a}function d(){}function g(a){return!a||"loaded"==a||"complete"==a||"uninitialized"==a}function h(){var a=F.shift();r=1;a?a.t?x(function(){("c"==a.t?L.injectCss:L.injectJs)(a.s,0,a.a,a.x,a.e,1)},0):(a(),h()):r=0}function k(a,b,f,e,d,k,l){function p(c){if(!s&&g(m.readyState)&&(C.r=s=1,!r&&h(),m.onload=m.onreadystatechange=null,c)){"img"!=a&&x(function(){z.removeChild(m)},50);for(var f in G[b])G[b].hasOwnProperty(f)&&
G[b][f].onload()}}l=l||L.errorTimeout;var m={},s=0,w=0,C={t:f,s:b,e:d,a:k,x:l};1===G[b]&&(w=1,G[b]=[],m=c.createElement(a));"object"==a?m.data=b:(m.src=b,m.type=a);m.width=m.height="0";m.onerror=m.onload=m.onreadystatechange=function(){p.call(this,w)};F.splice(e,0,C);"img"!=a&&(w||2===G[b]?(z.insertBefore(m,A?null:v),x(p,l)):G[b].push(m))}function l(a,b,c,f,d){return r=0,b=b||"j",e(a)?k("c"==b?H:D,a,b,this.i++,c,f,d):(F.splice(this.i++,0,a),1==F.length&&h()),this}function p(){var a=L;return a.loader=
{load:l,i:0},a}var s=c.documentElement,x=b.setTimeout,v=c.getElementsByTagName("script")[0],w={}.toString,F=[],r=0,E="MozAppearance"in s.style,A=E&&!!c.createRange().compareNode,z=A?s:v.parentNode,s=b.opera&&"[object Opera]"==w.call(b.opera),s=!!c.attachEvent&&!s,D=E?"object":s?"script":"img",H=s?"script":D,C=Array.isArray||function(a){return"[object Array]"==w.call(a)},M=[],G={},I={timeout:function(a,b){return b.length&&(a.timeout=b[0]),a}},N,L;L=function(b){function c(a){a=a.split("!");var b=M.length,
f=a.pop(),e=a.length,f={url:f,origUrl:f,prefixes:a},d,g,h;for(g=0;g<e;g++)h=a[g].split("="),(d=I[h.shift()])&&(f=d(f,h));for(g=0;g<b;g++)f=M[g](f);return f}function g(b,e,d,k,l){var q=c(b),r=q.autoCallback;q.url.split(".").pop().split("?").shift();q.bypass||(e&&(e=f(e)?e:e[b]||e[k]||e[b.split("/").pop().split("?")[0]]||h),q.instead?q.instead(b,e,d,k,l):(G[q.url]?q.noexec=!0:G[q.url]=1,d.load(q.url,q.forceCSS||!q.forceJS&&"css"==q.url.split(".").pop().split("?").shift()?"c":a,q.noexec,q.attrs,q.timeout),
(f(e)||f(r))&&d.load(function(){p();e&&e(q.origUrl,l,k);r&&r(q.origUrl,l,k);G[q.url]=2})))}function k(a,b){function c(a,d){if(a)if(e(a))d||(q=function(){var a=[].slice.call(arguments);p.apply(this,a);r()}),g(a,q,b,0,h);else{if(Object(a)===a)for(t in s=function(){var b=0,c;for(c in a)a.hasOwnProperty(c)&&b++;return b}(),a)a.hasOwnProperty(t)&&(!d&&!--s&&(f(q)?q=function(){var a=[].slice.call(arguments);p.apply(this,a);r()}:q[t]=function(a){return function(){var b=[].slice.call(arguments);a&&a.apply(this,
b);r()}}(p[t])),g(a[t],q,b,t,h))}else!d&&r()}var h=!!a.test,l=a.load||a.both,q=a.callback||d,p=q,r=a.complete||d,s,t;c(h?a.yep:a.nope,!!l);l&&c(l)}var l,r,s=this.yepnope.loader;if(e(b))g(b,0,s,0);else if(C(b))for(l=0;l<b.length;l++)r=b[l],e(r)?g(r,0,s,0):C(r)?L(r):Object(r)===r&&k(r,s);else Object(b)===b&&k(b,s)};L.addPrefix=function(a,b){I[a]=b};L.addFilter=function(a){M.push(a)};L.errorTimeout=1E4;null==c.readyState&&c.addEventListener&&(c.readyState="loading",c.addEventListener("DOMContentLoaded",
N=function(){c.removeEventListener("DOMContentLoaded",N,0);c.readyState="complete"},0));b.yepnope=p();b.yepnope.executeStack=h;b.yepnope.injectJs=function(a,b,f,e,k,l){var p=c.createElement("script"),r,m;e=e||L.errorTimeout;p.src=a;for(m in f)p.setAttribute(m,f[m]);b=l?h:b||d;p.onreadystatechange=p.onload=function(){!r&&g(p.readyState)&&(r=1,b(),p.onload=p.onreadystatechange=null)};x(function(){r||(r=1,b(1))},e);k?p.onload():v.parentNode.insertBefore(p,v)};b.yepnope.injectCss=function(a,b,f,e,g,k){e=
...
["strokeStyle",a],!1)]:null;return this};a.beginLinearGradientStroke=function(a,c,d,g,h,k){this._active&&this._newPath();d=this._ctx.createLinearGradient(d,g,h,k);g=0;for(h=a.length;g<h;g++)d.addColorStop(c[g],a[g]);this._strokeInstructions=[new b(this._setProp,["strokeStyle",d],!1)];return this};a.beginRadialGradientStroke=function(a,c,d,g,h,k,l,p){this._active&&this._newPath();d=this._ctx.createRadialGradient(d,g,h,k,l,p);g=0;for(h=a.length;g<h;g++)d.addColorStop(c[g],a[g]);this._strokeInstructions=
[new b(this._setProp,["strokeStyle",d],!1)];return this};a.beginBitmapStroke=function(a,c){this._active&&this._newPath();var d=this._ctx.createPattern(a,c||"");this._strokeInstructions=[new b(this._setProp,["strokeStyle",d],!1)];return this};a.endStroke=function(){this.beginStroke();return this};a.curveTo=a.quadraticCurveTo;a.drawRect=a.rect;a.drawRoundRect=function(a,b,c,g,h){this.drawRoundRectComplex(a,b,c,g,h,h,h,h);return this};a.drawRoundRectComplex=function(a,c,d,g,h,k,l,p){var s=(d<g?d:g)/
2,x=0,v=0,w=0,F=0;0>h&&(h*=x=-1);h>s&&(h=s);0>k&&(k*=v=-1);k>s&&(k=s);0>l&&(l*=w=-1);l>s&&(l=s);0>p&&(p*=F=-1);p>s&&(p=s);this._dirty=this._active=!0;var s=this._ctx.arcTo,r=this._ctx.lineTo;this._activeInstructions.push(new b(this._ctx.moveTo,[a+d-k,c]),new b(s,[a+d+k*v,c-k*v,a+d,c+k,k]),new b(r,[a+d,c+g-l]),new b(s,[a+d+l*w,c+g+l*w,a+d-l,c+g,l]),new b(r,[a+p,c+g]),new b(s,[a-p*F,c+g+p*F,a,c+g-p,p]),new b(r,[a,c+h]),new b(s,[a-h*x,c-h*x,a+h,c,h]),new b(this._ctx.closePath));return this};a.drawCircle=
function(a,b,c){this.arc(a,b,c,0,2*Math.PI);return this};a.drawEllipse=function(a,c,d,g){this._dirty=this._active=!0;var h=0.5522848*(d/2),k=0.5522848*(g/2),l=a+d,p=c+g;d=a+d/2;g=c+g/2;this._activeInstructions.push(new b(this._ctx.moveTo,[a,g]),new b(this._ctx.bezierCurveTo,[a,g-k,d-h,c,d,c]),new b(this._ctx.bezierCurveTo,[d+h,c,l,g-k,l,g]),new b(this._ctx.bezierCurveTo,[l,g+k,d+h,p,d,p]),new b(this._ctx.bezierCurveTo,[d-h,p,a,g+k,a,g]));return this};a.drawPolyStar=function(a,c,d,g,h,k){this._dirty=
this._active=!0;null==h&&(h=0);h=1-h;k=null==k?0:k/(180/Math.PI);var l=Math.PI/g;this._activeInstructions.push(new b(this._ctx.moveTo,[a+Math.cos(k)*d,c+Math.sin(k)*d]));for(var p=0;p<g;p++)k+=l,1!=h&&this._activeInstructions.push(new b(this._ctx.lineTo,[a+Math.cos(k)*d*h,c+Math.sin(k)*d*h])),k+=l,this._activeInstructions.push(new b(this._ctx.lineTo,[a+Math.cos(k)*d,c+Math.sin(k)*d]));return this};a.decodePath=function(a){for(var b=[this.moveTo,this.lineTo,this.quadraticCurveTo,this.bezierCurveTo,
this.closePath],d=[2,2,4,6,0],g=0,h=a.length,k=[],l=0,p=0,s=c.BASE_64;g<h;){var x=a.charAt(g),v=s[x],w=v>>3,F=b[w];if(!F||v&3)throw"bad path data (@"+g+"): "+x;x=d[w];w||(l=p=0);k.length=0;g++;v=(v>>2&1)+2;for(w=0;w<x;w++){var r=s[a.charAt(g)],E=r>>5?-1:1,r=(r&31)<<6|s[a.charAt(g+1)];3==v&&(r=r<<6|s[a.charAt(g+2)]);r=E*r/10;w%2?l=r+=l:p=r+=p;k[w]=r;g+=v}F.apply(this,k)}return this};a.clone=function(){var a=new c;a._instructions=this._instructions.slice();a._activeInstructions=this._activeInstructions.slice();
...
function(a,b,c,d,g,h,k,l,p){this.x=a||0;this.y=b||0;this.scaleX=null==c?1:c;this.scaleY=null==d?1:d;this.rotation=g||0;this.skewX=h||0;this.skewY=k||0;this.regX=l||0;this.regY=p||0;return this};c.getMatrix=function(a){return(a?a.identity():new createjs.Matrix2D).appendTransform(this.x,this.y,this.scaleX,this.scaleY,this.rotation,this.skewX,this.skewY,this.regX,this.regY).appendProperties(this.alpha,this.shadow,this.compositeOperation)};c.getConcatenatedMatrix=function(a){a?a.identity():a=new createjs.Matrix2D;
...
this._testHit(g)))return h.width=0,h.width=1,this;for(var p=this.children.length-1;0<=p;p--){var s=this.children[p],x=s.hitArea;if(s.visible&&!(!x&&!s.isVisible()||d&&!s.mouseEnabled)){var v=d&&s._hasMouseHandler(d);if(s instanceof b&&(!x||!v))if(l){if(s._getObjectsUnderPoint(a,c))return this}else{if(s=s._getObjectsUnderPoint(a,c,e,d),!e&&s)return s}else if(!d||l||v)if(s.getConcatenatedMatrix(k),x&&(k.appendTransform(x.x,x.y,x.scaleX,x.scaleY,x.rotation,x.skewX,x.skewY,x.regX,x.regY),k.alpha=x.alpha),
...
k;h++){var l=a.measureText(c[h]).width;if(null==this.lineWidth||l<this.lineWidth)b&&this._drawTextLine(a,c[h],g*d);else{for(var l=c[h].split(/(\s)/),p=l[0],s=1,x=l.length;s<x;s+=2)a.measureText(p+l[s]+l[s+1]).width>this.lineWidth?(b&&this._drawTextLine(a,p,g*d),g++,p=l[s+1]):p+=l[s]+l[s+1];b&&this._drawTextLine(a,p,g*d)}g++}return g};c._drawTextLine=function(a,b,c){this.outline?a.strokeText(b,0,c,this.maxWidth||65535):a.fillText(b,0,c,this.maxWidth||65535)};createjs.Text=b})();
...
a,f,e){for(var d=c._images,g=b._workingCanvas,h=b._workingContext,k=d.length/a,l=0;l<k;l++){var p=d[l];p.__tmp=l;g.width=0;g.width=p.width;g.height=p.height;h.setTransform(f?-1:1,0,0,e?-1:1,f?p.width:0,e?p.height:0);h.drawImage(p,0,0);var s=new Image;s.src=g.toDataURL("image/png");s.width=p.width;s.height=p.height;d.push(s)}h=c._frames;g=h.length/a;for(l=0;l<g;l++){var p=h[l],x=p.rect.clone(),s=d[p.image.__tmp+k*a],v={image:s,rect:x,regX:p.regX,regY:p.regY};f&&(x.x=s.width-x.x-x.width,v.regX=x.width-
p.regX);e&&(x.y=s.height-x.y-x.height,v.regY=x.height-p.regY);h.push(v)}f="_"+(f?"h":"")+(e?"v":"");e=c._animations;c=c._data;d=e.length/a;for(l=0;l<d;l++){h=e[l];p=c[h];k={name:h+f,frequency:p.frequency,next:p.next,frames:[]};p.next&&(k.next+=f);h=p.frames;p=0;for(s=h.length;p<s;p++)k.frames.push(h[p]+g*a);c[k.name]=k;e.push(k.name)}};createjs.SpriteSheetUtils=b})();this.createjs=this.createjs||{};
...
k=this.maxHeight;c+=g;for(var k=k-c,l=g,p=0,s=a.length-1;0<=s;s--){var x=a[s],v=this._scale*x.scale,w=x.sourceRect,F=x.source,r=Math.floor(v*w.x-g),E=Math.floor(v*w.y-g),A=Math.ceil(v*w.height+2*g),w=Math.ceil(v*w.width+2*g);if(w>h)throw b.ERR_DIMENSIONS;A>k||l+w>h||(x.img=e,x.rect=new createjs.Rectangle(l,c,w,A),p=p||A,a.splice(s,1),d[x.index]=[l,c,w,A,e,Math.round(-r+v*F.regX-g),Math.round(-E+v*F.regY-g)],l+=w)}return{w:l,h:p}};c._endBuild=function(){this.spriteSheet=new createjs.SpriteSheet(this._data);
...
};c._updateTargetProps=function(a,c){var e,d,g,h;!a&&1==c?e=d=this._curQueueProps:(a.e&&(c=a.e(c,0,1,1)),e=a.p0,d=a.p1);for(n in this._initQueueProps){if(null==(g=e[n]))e[n]=g=this._initQueueProps[n];if(null==(h=d[n]))d[n]=h=g;g=g==h||0==c||1==c||"number"!=typeof g?1==c?h:g:g+(h-g)*c;var k=!1;if(h=b._plugins[n])for(var l=0,p=h.length;l<p;l++){var s=h[l].tween(this,n,g,e,d,c,!!a&&e==d,!a);s==b.IGNORE?k=!0:g=s}k||(this._target[n]=g)}};c._runActions=function(a,b,c){var d=a,g=b,h=-1,k=this._actions.length,
l=1;for(a>b&&(d=b,g=a,h=k,k=l=-1);(h+=l)!=k;){b=this._actions[h];var p=b.t;(p==g||p>d&&p<g||c&&p==a)&&b.f.apply(b.o,b.p)}};c._appendQueueProps=function(a){var c,e,d,g,h,k;for(k in a){if(void 0===this._initQueueProps[k]){e=this._target[k];if(c=b._plugins[k]){d=0;for(g=c.length;d<g;d++)e=c[d].init(this,k,e)}this._initQueueProps[k]=void 0===e?null:e}else e=this._curQueueProps[k];if(c=b._plugins[k]){h=h||{};d=0;for(g=c.length;d<g;d++)c[d].step&&c[d].step(this,k,e,a[k],h)}this._curQueueProps[k]=a[k]}h&&
...
1);e.hasOwnProperty("start")||(e.start=f&&f.hasOwnProperty("end")&&f.path===c?f.end:0);if(e.hasOwnProperty("_segments")&&e._length)return e;f=c.length;if(6<=f&&0==(f-2)%4){e._segments=[];e._length=0;for(a=2;a<f;a+=4){for(var h=c[a-2],k=c[a-1],l=c[a+0],p=c[a+1],s=c[a+2],x=c[a+3],v=h,w=k,F,r,E=0,A=[],z=1;10>=z;z++){r=z/10;var D=1-r;F=D*D*h+2*D*r*l+r*r*s;r=D*D*k+2*D*r*p+r*r*x;E+=A[A.push(Math.sqrt((g=F-v)*g+(g=r-w)*g))-1];v=F;w=r}e._segments.push(E);e._segments.push(A);e._length+=E}}else throw"invalid 'path' data, please see documentation for valid paths";
...
var Stats=function(){var b=Date.now(),c=b,a=0,f=Infinity,e=0,d=0,g=Infinity,h=0,k=0,l=0,p=document.createElement("div");p.id="stats";p.addEventListener("mousedown",function(a){a.preventDefault();A(++l%2)},!1);p.style.cssText="width:80px;opacity:0.9;cursor:pointer";var s=document.createElement("div");s.id="fps";s.style.cssText="padding:0 0 3px 3px;text-align:left;background-color:#002";p.appendChild(s);var x=document.createElement("div");x.id="fpsText";x.style.cssText="color:#0ff;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px";
x.innerHTML="FPS";s.appendChild(x);var v=document.createElement("div");v.id="fpsGraph";v.style.cssText="position:relative;width:74px;height:30px;background-color:#0ff";for(s.appendChild(v);74>v.children.length;){var w=document.createElement("span");w.style.cssText="width:1px;height:30px;float:left;background-color:#113";v.appendChild(w)}var F=document.createElement("div");F.id="ms";F.style.cssText="padding:0 0 3px 3px;text-align:left;background-color:#020;display:none";p.appendChild(F);var r=document.createElement("div");
r.id="msText";r.style.cssText="color:#0f0;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px";r.innerHTML="MS";F.appendChild(r);var E=document.createElement("div");E.id="msGraph";E.style.cssText="position:relative;width:74px;height:30px;background-color:#0f0";for(F.appendChild(E);74>E.children.length;)w=document.createElement("span"),w.style.cssText="width:1px;height:30px;float:left;background-color:#131",E.appendChild(w);var A=function(a){l=a;switch(l){case 0:s.style.display=
"block";F.style.display="none";break;case 1:s.style.display="none",F.style.display="block"}};return{REVISION:11,domElement:p,setMode:A,begin:function(){b=Date.now()},end:function(){var l=Date.now();a=l-b;f=Math.min(f,a);e=Math.max(e,a);r.textContent=a+" MS ("+f+"-"+e+")";var p=Math.min(30,30-30*(a/200));E.appendChild(E.firstChild).style.height=p+"px";k++;l>c+1E3&&(d=Math.round(1E3*k/(l-c)),g=Math.min(g,d),h=Math.max(h,d),x.textContent=d+" FPS ("+g+"-"+h+")",p=Math.min(30,30-30*(d/100)),v.appendChild(v.firstChild).style.height=
p+"px",c=l,k=0);return l},update:function(){b=this.end()}}};
Box2D.Common.Separator=function(){var b=function(a,b,c,g,h,k){var l;if(l=(c+0.1>=a&&a>=h-0.1||c-0.1<=a&&a<=h+0.1)&&(g+0.1>=b&&b>=k-0.1||g-0.1<=b&&b<=k+0.1))0.1<h-c||0.1<c-h?(a=(k-g)/(h-c)*(a-c)+g,l=0.1>(a>b?a-b:b-a)):l=0.1>a-c||0.1>c-a;return l},c=function(a,b,c,g){return 0.1>(c>=a?c-a:a-c)&&0.1>(g>=b?g-b:b-g)},a=function(){throw Error("A problem has occurred. Use the Validate() method to see where the problem is.");};return{Separate:function(f,e,d,g){g=g||30;var h,k=d.length,l,p,s=[];for(h=0;h<k;h++)s.push(new Ses.b2Vec2(d[h].x*
g,d[h].y*g));var x,v,w,F,r,E,A,z,D,H,C,M,G,I,N=[];d=[];for(d.push(s);d.length;){h=d[0];k=h.length;I=!0;for(x=0;x<k;x++)if(s=x,A=x<k-1?x+1:x+1-k,w=x<k-2?x+2:x+2-k,z=h[s],D=h[A],w=h[w],w=z.x*D.y+D.x*w.y+w.x*z.y-z.y*D.x-D.y*w.x-w.y*z.x,0>w){I=!1;E=Number.MAX_VALUE;for(v=0;v<k;v++)if(v!=s&&v!=A){x=v;w=v<k-1?v+1:0;H=h[x];C=h[w];F=z.x;r=z.y;var L=D.x,q=D.y;M=H.x;H=H.y;var t=C.x;C=C.y;var B=L-F,y=q-r,K=t-M,P=C-H,O=void 0,O=(K*(H-r)-P*(M-F))/(y*K-B*P),B=F+O*B,y=r+O*y;F=b(L,q,F,r,B,y);M=b(B,y,M,H,t,C);if(M=
F&&M?new Ses.b2Vec2(B,y):null)F=D.x-M.x,r=D.y-M.y,F=F*F+r*r,F<E&&(p=x,l=w,G=M,E=F)}E==Number.MAX_VALUE&&a();v=[];E=[];x=p;w=l;H=h[x];C=h[w];c(G.x,G.y,C.x,C.y)||v.push(G);c(G.x,G.y,H.x,H.y)||E.push(G);p=-1;for(l=s;;){if(l!=w)v.push(h[l]);else{(0>p||p>=k)&&a();b(C.x,C.y,h[p].x,h[p].y,z.x,z.y)||v.push(h[l]);break}p=l;0>l-1?l=k-1:l--}v=v.reverse();p=-1;for(l=A;;){if(l!=x)E.push(h[l]);else{(0>p||p>=k)&&a();l==x&&!b(H.x,H.y,h[p].x,h[p].y,D.x,D.y)&&E.push(h[l]);break}p=l;l+1>k-1?l=0:l++}d.push(v,E);d.shift();
break}I&&N.push(d.shift())}k=N.length;for(h=0;h<k;h++){d=[];s=N[h];p=s.length;for(l=0;l<p;l++)d.push(new Ses.b2Vec2(s[l].x/g,s[l].y/g));l=new Ses.b2PolygonShape;l.SetAsVector(d);e.shape=l;f.CreateFixture(e)}},Validate:function(a){var c,d=a.length,g,h,k,l,p,s=0,x,v=!1;for(c=0;c<d;c++){k=c<d-1?c+1:0;l=0<c?c-1:d-1;x=!1;for(g=0;g<d;g++)if(g!=c&&g!=k&&(x||(p=a[c].x*a[k].y+a[k].x*a[g].y+a[g].x*a[c].y-a[c].y*a[k].x-a[k].y*a[g].x-a[g].y*a[c].x,0<p&&(x=!0)),g!=l)){h=g<d-1?g+1:0;var w=a[c].x,F=a[c].y,r=a[k].x,
E=a[k].y;p=a[g].x;var A=a[g].y,z=a[h].x;h=a[h].y;var D=r-w,H=E-F,C=z-p,M=h-A,G=void 0,G=(C*(A-F)-M*(p-w))/(H*C-D*M),D=w+G*D,H=F+G*H,w=b(D,H,w,F,r,E);p=b(D,H,p,A,z,h);p=w&&p?new Ses.b2Vec2(D,H):null;p&&(s=1)}x||(v=!0)}v&&(s=1==s?3:2);return s},validateToString:function(a){switch(a){case 0:return"0 if the vertices can be properly processed.";case 1:return"1 If there are overlapping lines.";case 2:return"2 if the points are <b>not</b> in clockwise order.";case 3:return"3 if there are overlapping lines <b>and</b> the points are <b>not</b> in clockwise order.";
...
new createjs.Shape(f)},update:function(){this._super()},createRandomConvexPolygon:function(b,c,a){for(var f=2*Math.PI/a,e=[],d=0;d<a;++d){for(var g=d*f+f/3,h=(d+1)*f-f/3,k,l;;){k=Math.random()*b;k*=0.5<Math.random()?1:-1;l=Math.random()*b;l*=0.5<Math.random()?1:-1;var p=Math.sqrt(k*k+l*l);if(!(p<c||p>b))if(p=Math.atan2(l,k),g<Math.PI){if(p>g&&p<h)break}else{var s=-Math.PI+(g-Math.PI),x=s+f;if(p>s&&p<x)break}}e.push(new Ses.b2Vec2(k,l))}return e}});
...
Ses.Engine.Graphics="medium";break;case 2:e.innerHTML="graphics: high",Ses.Engine.Graphics="high"}};f.onclick=function(){a.style.display="none";Ses.Engine.restartMap()};d.onclick=function(){a.style.display="none";b.style.display="block"};return{addMap:function(a,d){var e=document.createElement("div");e.className="ui button";e.innerHTML=a;e.onclick=function(){b.style.display="none";d.call()};c.appendChild(e)},showGameOver:function(b,c){a.querySelector("h1").innerHTML="mission fail";["#stars1","#stars2",
"#stars3"].forEach(function(b,c){a.querySelector(b).style.display="none"});a.querySelector("p").innerHTML="";a.querySelector("#next-map").style.display="none";a.style.display="block";_gaq.push(["_trackEvent",b,"fail","time",c/1E3])},showGameWin:function(b,c,d){a.querySelector("h1").innerHTML="mission succes";["#stars1","#stars2","#stars3"].forEach(function(b,c){a.querySelector(b).style.display=d===c+1?"inline":"none"});var e=Math.floor(c/6E4),f=Math.floor((c-6E4*e)/1E3);a.querySelector("p").innerHTML=
"Time: "+(9<e?e:"0"+e)+":"+(9<f?f:"0"+f)+"."+c%1E3;e=a.querySelector("#next-map");e.onclick=function(){a.style.display="none";Ses.Engine.nextMap()};e.style.display="block";a.style.display="block";_gaq.push(["_trackEvent",b,"win","stars",d]);_gaq.push(["_trackEvent",b,"win","time played",Math.floor(c/1E3)])}}}();
